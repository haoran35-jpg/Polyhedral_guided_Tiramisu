...
void generate_function(std::string name)
{
    ...
    B1_prop_r.store_in( &buf_B1_prop_r_gpu, {tri, TIME_SLICE, iCprime, iSprime, jCprime, jSprime, x, y} );
    B1_prop_i.store_in( &buf_B1_prop_i_gpu, {tri, TIME_SLICE, iCprime, iSprime, jCprime, jSprime, x, y} );
    B2_prop_r.store_in( &buf_B2_prop_r_gpu, {tri, TIME_SLICE, iCprime, iSprime, jCprime, jSprime, x, y} );
    B2_prop_i.store_in( &buf_B2_prop_i_gpu, {tri, TIME_SLICE, iCprime, iSprime, jCprime, jSprime, x, y} );
    ...
    complex_expr B1_r1_prop_0 = B1_prop( cast( p_int64, 0 ), TIME_SLICE, iCprime, iSprime, src_color_weights(0, wnumBlock, 0), src_spin_weights(0, wnumBlock, 0), x1 * tiling_factor + tile1, y);
    complex_expr B1_r1_prop_1 = B1_prop( cast( p_int64, 1 ), TIME_SLICE, jCprime, jSprime, src_color_weights(0, wnumBlock, 1), src_spin_weights(0, wnumBlock, 1), x1 * tiling_factor + tile1, y);
    complex_expr B1_r1_prop_2 = B1_prop( cast( p_int64, 2 ), TIME_SLICE, kCprime, kSprime, src_color_weights(0, wnumBlock, 2), src_spin_weights(0, wnumBlock, 2), x1 * tiling_factor + tile1, y);
    complex_expr first_B1_r1_prop_0 =  B1_prop( cast( p_int64, 0 ), TIME_SLICE, iCprime, iSprime, src_color_weights(0, wnumBlock, 0), src_spin_weights(0, wnumBlock, 0), x2 * tiling_factor + tile2, y);
    complex_expr second_B1_r1_prop_1 = B1_prop( cast( p_int64, 1 ), TIME_SLICE, jCprime, jSprime, src_color_weights(0, wnumBlock, 1), src_spin_weights(0, wnumBlock, 1), x2 * tiling_factor + tile2, y);
    complex_expr third_B1_r1_prop_2 =  B1_prop( cast( p_int64, 2 ), TIME_SLICE, kCprime, kSprime, src_color_weights(0, wnumBlock, 2), src_spin_weights(0, wnumBlock, 2), x2 * tiling_factor + tile2, y);
    ...
    complex_expr B1_r2_prop_0 = B1_prop( cast( p_int64, 0 ), TIME_SLICE, iCprime, iSprime, src_color_weights(1, wnumBlock, 0), src_spin_weights(1, wnumBlock, 0), x1 * tiling_factor + tile1, y);
    complex_expr B1_r2_prop_2 = B1_prop( cast( p_int64, 2 ), TIME_SLICE, kCprime, kSprime, src_color_weights(1, wnumBlock, 2), src_spin_weights(1, wnumBlock, 2), x1 * tiling_factor + tile1, y);
    complex_expr B1_r2_prop_1 = B1_prop( cast( p_int64, 1 ), TIME_SLICE, jCprime, jSprime, src_color_weights(1, wnumBlock, 1), src_spin_weights(1, wnumBlock, 1), x1 * tiling_factor + tile1, y);
    complex_expr first_B1_r2_prop_0 =  B1_prop( cast( p_int64, 0 ), TIME_SLICE, iCprime, iSprime, src_color_weights(1, wnumBlock, 0), src_spin_weights(1, wnumBlock, 0), x2 * tiling_factor + tile2, y);
    complex_expr second_B1_r2_prop_1 = B1_prop( cast( p_int64, 1 ), TIME_SLICE, jCprime, jSprime, src_color_weights(1, wnumBlock, 1), src_spin_weights(1, wnumBlock, 1), x2 * tiling_factor + tile2, y);
    complex_expr third_B1_r2_prop_2 =  B1_prop( cast( p_int64, 2 ), TIME_SLICE, kCprime, kSprime, src_color_weights(1, wnumBlock, 2), src_spin_weights(1, wnumBlock, 2), x2 * tiling_factor + tile2, y);
    ...
    complex_expr B2_r1_prop_0 = B2_prop(0, TIME_SLICE, iCprime, iSprime, src_color_weights(0, wnumBlock, 0), src_spin_weights(0, wnumBlock, 0), x2 * tiling_factor + tile2, y);
    complex_expr B2_r1_prop_2 = B2_prop(2, TIME_SLICE, kCprime, kSprime, src_color_weights(0, wnumBlock, 2), src_spin_weights(0, wnumBlock, 2), x2 * tiling_factor + tile2, y);
    complex_expr B2_r1_prop_1 = B2_prop(1, TIME_SLICE, jCprime, jSprime, src_color_weights(0, wnumBlock, 1), src_spin_weights(0, wnumBlock, 1), x2 * tiling_factor + tile2, y);
    complex_expr first_B2_r1_prop_0 =  B2_prop(0, TIME_SLICE, iCprime, iSprime, src_color_weights(0, wnumBlock, 0), src_spin_weights(0, wnumBlock, 0), x1 * tiling_factor + tile1, y);
    complex_expr second_B2_r1_prop_1 = B2_prop(1, TIME_SLICE, jCprime, jSprime, src_color_weights(0, wnumBlock, 1), src_spin_weights(0, wnumBlock, 1), x1 * tiling_factor + tile1, y);
    complex_expr third_B2_r1_prop_2 =  B2_prop(2, TIME_SLICE, kCprime, kSprime, src_color_weights(0, wnumBlock, 2), src_spin_weights(0, wnumBlock, 2), x1 * tiling_factor + tile1, y);
    ...
    complex_expr B2_r2_prop_0 = B2_prop(0, TIME_SLICE, iCprime, iSprime, src_color_weights(1, wnumBlock, 0), src_spin_weights(1, wnumBlock, 0), x2 * tiling_factor + tile2, y);
    complex_expr B2_r2_prop_2 = B2_prop(2, TIME_SLICE, kCprime, kSprime, src_color_weights(1, wnumBlock, 2), src_spin_weights(1, wnumBlock, 2), x2 * tiling_factor + tile2, y);
    complex_expr B2_r2_prop_1 = B2_prop(1, TIME_SLICE, jCprime, jSprime, src_color_weights(1, wnumBlock, 1), src_spin_weights(1, wnumBlock, 1), x2 * tiling_factor + tile2, y);
    complex_expr first_B2_r2_prop_0 =  B2_prop(0, TIME_SLICE, iCprime, iSprime, src_color_weights(1, wnumBlock, 0), src_spin_weights(1, wnumBlock, 0), x1 * tiling_factor + tile1, y);
    complex_expr second_B2_r2_prop_1 = B2_prop(1, TIME_SLICE, jCprime, jSprime, src_color_weights(1, wnumBlock, 1), src_spin_weights(1, wnumBlock, 1), x1 * tiling_factor + tile1, y);
    complex_expr third_B2_r2_prop_2 =  B2_prop(2, TIME_SLICE, kCprime, kSprime, src_color_weights(1, wnumBlock, 2), src_spin_weights(1, wnumBlock, 2), x1 * tiling_factor + tile1, y);
...
// BB_H
    ...
    complex_expr src_B1_r1_prop_0 = B1_prop( cast( p_int64, 0 ), TIME_SLICE, iCprime, iSprime, src_color_weights(0, wnumBlock, 0), src_spin_weights(0, wnumBlock, 0), x_out*sites_per_rank+x_in, y);
    complex_expr src_B1_r1_prop_2 = B1_prop( cast( p_int64, 2 ), TIME_SLICE, kCprime, kSprime, src_color_weights(0, wnumBlock, 2), src_spin_weights(0, wnumBlock, 2), x_out*sites_per_rank+x_in, y);
    complex_expr src_B1_r1_prop_1 = B1_prop( cast( p_int64, 1 ), TIME_SLICE, jCprime, jSprime, src_color_weights(0, wnumBlock, 1), src_spin_weights(0, wnumBlock, 1), x_out*sites_per_rank+x_in, y);
    ...
    complex_expr src_B1_r2_prop_0 =  B1_prop( cast( p_int64, 0 ), TIME_SLICE, iCprime, iSprime, src_color_weights(1, wnumBlock, 0), src_spin_weights(1, wnumBlock, 0), x_out*sites_per_rank+x_in, y);
    complex_expr src_B1_r2_prop_2 =  B1_prop( cast( p_int64, 2 ), TIME_SLICE, kCprime, kSprime, src_color_weights(1, wnumBlock, 2), src_spin_weights(1, wnumBlock, 2), x_out*sites_per_rank+x_in, y);
    complex_expr src_B1_r2_prop_0p = B1_prop( cast( p_int64, 0 ), TIME_SLICE, kCprime, kSprime, src_color_weights(1, wnumBlock, 0), src_spin_weights(1, wnumBlock, 0), x_out*sites_per_rank+x_in, y);
    complex_expr src_B1_r2_prop_2p = B1_prop( cast( p_int64, 2 ), TIME_SLICE, iCprime, iSprime, src_color_weights(1, wnumBlock, 2), src_spin_weights(1, wnumBlock, 2), x_out*sites_per_rank+x_in, y);
    complex_expr src_B1_r2_prop_1 =  B1_prop( cast( p_int64, 1 ), TIME_SLICE, jCprime, jSprime, src_color_weights(1, wnumBlock, 1), src_spin_weights(1, wnumBlock, 1), x_out*sites_per_rank+x_in, y);
    ...
    complex_expr src_B2_r1_prop_0 = B2_prop(0, TIME_SLICE, iCprime, iSprime, src_color_weights(0, wnumBlock, 0), src_spin_weights(0, wnumBlock, 0), x_out*sites_per_rank+x_in, y);
    complex_expr src_B2_r1_prop_2 = B2_prop(2, TIME_SLICE, kCprime, kSprime, src_color_weights(0, wnumBlock, 2), src_spin_weights(0, wnumBlock, 2), x_out*sites_per_rank+x_in, y);
    complex_expr src_B2_r1_prop_1 = B2_prop(1, TIME_SLICE, jCprime, jSprime, src_color_weights(0, wnumBlock, 1), src_spin_weights(0, wnumBlock, 1), x_out*sites_per_rank+x_in, y);
    ...
    complex_expr src_B2_r2_prop_0 = B2_prop(0, TIME_SLICE, iCprime, iSprime, src_color_weights(1, wnumBlock, 0), src_spin_weights(1, wnumBlock, 0), x_out*sites_per_rank+x_in, y);
    complex_expr src_B2_r2_prop_2 = B2_prop(2, TIME_SLICE, kCprime, kSprime, src_color_weights(1, wnumBlock, 2), src_spin_weights(1, wnumBlock, 2), x_out*sites_per_rank+x_in, y);
    complex_expr src_B2_r2_prop_1 = B2_prop(1, TIME_SLICE, jCprime, jSprime, src_color_weights(1, wnumBlock, 1), src_spin_weights(1, wnumBlock, 1), x_out*sites_per_rank+x_in, y);
    ...
    complex_expr snk_B1_r1_prop_0 = B1_prop( cast( p_int64, 0 ), TIME_SLICE, src_color_weights(0, wnumBlock, 0), src_spin_weights(0, wnumBlock, 0), iCprime, iSprime, x, y_out*src_sites_per_rank+y_in);
    complex_expr snk_B1_r1_prop_2 = B1_prop( cast( p_int64, 2 ), TIME_SLICE, src_color_weights(0, wnumBlock, 2), src_spin_weights(0, wnumBlock, 2), kCprime, kSprime, x, y_out*src_sites_per_rank+y_in);
    complex_expr snk_B1_r1_prop_1 = B1_prop( cast( p_int64, 1 ), TIME_SLICE, src_color_weights(0, wnumBlock, 1), src_spin_weights(0, wnumBlock, 1), jCprime, jSprime, x, y_out*src_sites_per_rank+y_in);
    ...
    complex_expr snk_B1_r2_prop_0 = B1_prop( cast( p_int64, 0 ), TIME_SLICE, src_color_weights(1, wnumBlock, 0), src_spin_weights(1, wnumBlock, 0), iCprime, iSprime, x, y_out*src_sites_per_rank+y_in);
    complex_expr snk_B1_r2_prop_2 = B1_prop( cast( p_int64, 2 ), TIME_SLICE, src_color_weights(1, wnumBlock, 2), src_spin_weights(1, wnumBlock, 2), kCprime, kSprime, x, y_out*src_sites_per_rank+y_in);
    complex_expr snk_B1_r2_prop_1 = B1_prop( cast( p_int64, 1 ), TIME_SLICE, src_color_weights(1, wnumBlock, 1), src_spin_weights(1, wnumBlock, 1), jCprime, jSprime, x, y_out*src_sites_per_rank+y_in);
    ...
    complex_expr snk_B2_r1_prop_0 = B2_prop(0, TIME_SLICE, src_color_weights(0, wnumBlock, 0), src_spin_weights(0, wnumBlock, 0), iCprime, iSprime, x, y_out*src_sites_per_rank+y_in);
    complex_expr snk_B2_r1_prop_2 = B2_prop(2, TIME_SLICE, src_color_weights(0, wnumBlock, 2), src_spin_weights(0, wnumBlock, 2), kCprime, kSprime, x, y_out*src_sites_per_rank+y_in);
    complex_expr snk_B2_r1_prop_1 = B2_prop(1, TIME_SLICE, src_color_weights(0, wnumBlock, 1), src_spin_weights(0, wnumBlock, 1), jCprime, jSprime, x, y_out*src_sites_per_rank+y_in);
    ...
    complex_expr snk_B2_r2_prop_0 = B2_prop(0, TIME_SLICE, src_color_weights(1, wnumBlock, 0), src_spin_weights(1, wnumBlock, 0), iCprime, iSprime, x, y_out*src_sites_per_rank+y_in);
    complex_expr snk_B2_r2_prop_2 = B2_prop(2, TIME_SLICE, src_color_weights(1, wnumBlock, 2), src_spin_weights(1, wnumBlock, 2), kCprime, kSprime, x, y_out*src_sites_per_rank+y_in);
    complex_expr snk_B2_r2_prop_1 = B2_prop(1, TIME_SLICE, src_color_weights(1, wnumBlock, 1), src_spin_weights(1, wnumBlock, 1), jCprime, jSprime, x, y_out*src_sites_per_rank+y_in);
    ...
    // BB_BB
    computation C_BB_BB_prop_init_r("C_BB_BB_prop_init_r", { tile1, tile2, x1, rp, x2, r, m}, expr((double) 0));
    computation C_BB_BB_prop_init_i("C_BB_BB_prop_init_i", { tile1, tile2, x1, rp, x2, r, m}, expr((double) 0));
    
    b=0;
    // r1, b = 0 
    complex_computation BB_BB_new_term_0_r1_b1("BB_BB_new_term_0_r1_b1", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B1_Blocal_r1_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation BB_BB_new_term_1_r1_b1("BB_BB_new_term_1_r1_b1", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B2_Blocal_r1_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation BB_BB_new_term_2_r1_b1("BB_BB_new_term_2_r1_b1", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B1_Bfirst_r1_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation BB_BB_new_term_3_r1_b1("BB_BB_new_term_3_r1_b1", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B2_Bfirst_r1_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation BB_BB_new_term_4_r1_b1("BB_BB_new_term_4_r1_b1", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B1_Bsecond_r1_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation BB_BB_new_term_5_r1_b1("BB_BB_new_term_5_r1_b1", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B2_Bsecond_r1_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation BB_BB_new_term_6_r1_b1("BB_BB_new_term_6_r1_b1", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B1_Bthird_r1_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation BB_BB_new_term_7_r1_b1("BB_BB_new_term_7_r1_b1", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B2_Bthird_r1_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    ...
    // r2, b = 0 
    complex_computation BB_BB_new_term_0_r2_b1("BB_BB_new_term_0_r2_b1", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B1_Blocal_r2_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation BB_BB_new_term_1_r2_b1("BB_BB_new_term_1_r2_b1", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B2_Blocal_r2_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation BB_BB_new_term_2_r2_b1("BB_BB_new_term_2_r2_b1", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B1_Bfirst_r2_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation BB_BB_new_term_3_r2_b1("BB_BB_new_term_3_r2_b1", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B2_Bfirst_r2_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation BB_BB_new_term_4_r2_b1("BB_BB_new_term_4_r2_b1", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B1_Bsecond_r2_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation BB_BB_new_term_5_r2_b1("BB_BB_new_term_5_r2_b1", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B2_Bsecond_r2_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation BB_BB_new_term_6_r2_b1("BB_BB_new_term_6_r2_b1", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B1_Bthird_r2_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation BB_BB_new_term_7_r2_b1("BB_BB_new_term_7_r2_b1", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B2_Bthird_r2_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    ...
    b=1;
    // r1, b = 1 
    complex_computation BB_BB_new_term_0_r1_b2("BB_BB_new_term_0_r1_b2", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B1_Blocal_r1_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation BB_BB_new_term_1_r1_b2("BB_BB_new_term_1_r1_b2", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B2_Blocal_r1_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation BB_BB_new_term_2_r1_b2("BB_BB_new_term_2_r1_b2", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B1_Bfirst_r1_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation BB_BB_new_term_3_r1_b2("BB_BB_new_term_3_r1_b2", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B2_Bfirst_r1_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation BB_BB_new_term_4_r1_b2("BB_BB_new_term_4_r1_b2", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B1_Bsecond_r1_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation BB_BB_new_term_5_r1_b2("BB_BB_new_term_5_r1_b2", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B2_Bsecond_r1_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation BB_BB_new_term_6_r1_b2("BB_BB_new_term_6_r1_b2", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B1_Bthird_r1_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation BB_BB_new_term_7_r1_b2("BB_BB_new_term_7_r1_b2", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B2_Bthird_r1_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    ...
    // r2, b = 1
    complex_computation BB_BB_new_term_1_r2_b2("BB_BB_new_term_1_r2_b2", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B2_Blocal_r2_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation BB_BB_new_term_0_r2_b2("BB_BB_new_term_0_r2_b2", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B1_Blocal_r2_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation BB_BB_new_term_2_r2_b2("BB_BB_new_term_2_r2_b2", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B1_Bfirst_r2_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation BB_BB_new_term_3_r2_b2("BB_BB_new_term_3_r2_b2", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B2_Bfirst_r2_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation BB_BB_new_term_4_r2_b2("BB_BB_new_term_4_r2_b2", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B1_Bsecond_r2_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation BB_BB_new_term_5_r2_b2("BB_BB_new_term_5_r2_b2", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B2_Bsecond_r2_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation BB_BB_new_term_6_r2_b2("BB_BB_new_term_6_r2_b2", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B1_Bthird_r2_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation BB_BB_new_term_7_r2_b2("BB_BB_new_term_7_r2_b2", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B2_Bthird_r2_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    ...
    complex_expr BB_BB_term_res_b1 = BB_BB_new_term_0_r1_b1( tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum);
    complex_expr BB_BB_term_res_b2 = BB_BB_new_term_0_r1_b2( tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum);

    complex_expr BB_BB_term_res = prefactor * BB_BB_term_res_b1 * BB_BB_term_res_b2;

    b=0;
    // r1, b = 0 
    complex_computation flip_BB_BB_new_term_0_r1_b1("flip_BB_BB_new_term_0_r1_b1", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B1_Blocal_r1_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation flip_BB_BB_new_term_1_r1_b1("flip_BB_BB_new_term_1_r1_b1", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B2_Blocal_r1_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation flip_BB_BB_new_term_2_r1_b1("flip_BB_BB_new_term_2_r1_b1", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B1_Bfirst_r1_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation flip_BB_BB_new_term_3_r1_b1("flip_BB_BB_new_term_3_r1_b1", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B2_Bfirst_r1_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation flip_BB_BB_new_term_4_r1_b1("flip_BB_BB_new_term_4_r1_b1", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B1_Bsecond_r1_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation flip_BB_BB_new_term_5_r1_b1("flip_BB_BB_new_term_5_r1_b1", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B2_Bsecond_r1_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation flip_BB_BB_new_term_6_r1_b1("flip_BB_BB_new_term_6_r1_b1", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B1_Bthird_r1_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation flip_BB_BB_new_term_7_r1_b1("flip_BB_BB_new_term_7_r1_b1", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B2_Bthird_r1_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    ...
    // r2, b = 0 
    complex_computation flip_BB_BB_new_term_0_r2_b1("flip_BB_BB_new_term_0_r2_b1", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B1_Blocal_r2_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation flip_BB_BB_new_term_1_r2_b1("flip_BB_BB_new_term_1_r2_b1", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B2_Blocal_r2_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation flip_BB_BB_new_term_2_r2_b1("flip_BB_BB_new_term_2_r2_b1", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B1_Bfirst_r2_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation flip_BB_BB_new_term_3_r2_b1("flip_BB_BB_new_term_3_r2_b1", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B2_Bfirst_r2_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation flip_BB_BB_new_term_4_r2_b1("flip_BB_BB_new_term_4_r2_b1", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B1_Bsecond_r2_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation flip_BB_BB_new_term_5_r2_b1("flip_BB_BB_new_term_5_r2_b1", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B2_Bsecond_r2_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation flip_BB_BB_new_term_6_r2_b1("flip_BB_BB_new_term_6_r2_b1", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B1_Bthird_r2_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation flip_BB_BB_new_term_7_r2_b1("flip_BB_BB_new_term_7_r2_b1", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B2_Bthird_r2_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    ...
    b=1;
    // r1, b = 1 
    complex_computation flip_BB_BB_new_term_0_r1_b2("flip_BB_BB_new_term_0_r1_b2", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B1_Blocal_r1_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation flip_BB_BB_new_term_1_r1_b2("flip_BB_BB_new_term_1_r1_b2", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B2_Blocal_r1_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation flip_BB_BB_new_term_2_r1_b2("flip_BB_BB_new_term_2_r1_b2", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B1_Bfirst_r1_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation flip_BB_BB_new_term_3_r1_b2("flip_BB_BB_new_term_3_r1_b2", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B2_Bfirst_r1_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation flip_BB_BB_new_term_4_r1_b2("flip_BB_BB_new_term_4_r1_b2", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B1_Bsecond_r1_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation flip_BB_BB_new_term_5_r1_b2("flip_BB_BB_new_term_5_r1_b2", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B2_Bsecond_r1_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation flip_BB_BB_new_term_6_r1_b2("flip_BB_BB_new_term_6_r1_b2", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B1_Bthird_r1_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation flip_BB_BB_new_term_7_r1_b2("flip_BB_BB_new_term_7_r1_b2", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B2_Bthird_r1_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    ...
    // r2, b = 1 
    complex_computation flip_BB_BB_new_term_0_r2_b2("flip_BB_BB_new_term_0_r2_b2", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B1_Blocal_r2_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation flip_BB_BB_new_term_1_r2_b2("flip_BB_BB_new_term_1_r2_b2", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B2_Blocal_r2_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation flip_BB_BB_new_term_2_r2_b2("flip_BB_BB_new_term_2_r2_b2", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B1_Bfirst_r2_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation flip_BB_BB_new_term_3_r2_b2("flip_BB_BB_new_term_3_r2_b2", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B2_Bfirst_r2_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation flip_BB_BB_new_term_4_r2_b2("flip_BB_BB_new_term_4_r2_b2", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B1_Bsecond_r2_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation flip_BB_BB_new_term_5_r2_b2("flip_BB_BB_new_term_5_r2_b2", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B2_Bsecond_r2_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation flip_BB_BB_new_term_6_r2_b2("flip_BB_BB_new_term_6_r2_b2", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B1_Bthird_r2_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation flip_BB_BB_new_term_7_r2_b2("flip_BB_BB_new_term_7_r2_b2", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B2_Bthird_r2_init( tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    ...
    complex_expr flip_BB_BB_term_res_b1 = flip_BB_BB_new_term_0_r1_b1( tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum);
    complex_expr flip_BB_BB_term_res_b2 = flip_BB_BB_new_term_0_r1_b2( tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum);

    complex_expr flip_BB_BB_term_res = prefactor * flip_BB_BB_term_res_b1 * flip_BB_BB_term_res_b2;

    computation C_BB_BB_prop_update_r("C_BB_BB_prop_update_r", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, C_BB_BB_prop_init_r( tile1, tile2, x1, rp, x2, r, m) + tiramisu::expr( 0.5 ) * BB_BB_term_res.get_real() );
    computation C_BB_BB_prop_update_i("C_BB_BB_prop_update_i", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, C_BB_BB_prop_init_i( tile1, tile2, x1, rp, x2, r, m) + tiramisu::expr( 0.5 ) * BB_BB_term_res.get_imag() );

    computation C_BB_BB_prop_update_r_2("C_BB_BB_prop_update_r_2", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, C_BB_BB_prop_init_r( tile1, tile2, x1, rp, x2, r, m) + tiramisu::expr( 0.5 ) * flip_BB_BB_term_res.get_real() );
    computation C_BB_BB_prop_update_i_2("C_BB_BB_prop_update_i_2", { tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, C_BB_BB_prop_init_i( tile1, tile2, x1, rp, x2, r, m) + tiramisu::expr( 0.5 ) * flip_BB_BB_term_res.get_imag() );

    complex_computation C_BB_BB_prop_update(&C_BB_BB_prop_update_r, &C_BB_BB_prop_update_i);

    complex_expr BB_BB_term_s = (snk_psi_B1_ue * snk_psi_B2_x2_ue + snk_psi_B1_x2_ue * snk_psi_B2_ue) * C_BB_BB_prop_update( tile1, tile2, x1, rp, x2, r, m, 1, Nperms-1, Nw2-1);
    complex_expr BB_BB_term_b = snk_psi * C_BB_BB_prop_update( tile1, tile2, x1, rp, x2, r, m, 1, Nperms-1, Nw2-1);

    computation C_BB_init_r("C_BB_init_r", { tile1, tile2, x1, rp, x2, r, m, n}, expr((double) 0));
    computation C_BB_init_i("C_BB_init_i", { tile1, tile2, x1, rp, x2, r, m, n}, expr((double) 0));
    computation buf_C_BB_r_cpu_init("buf_C_BB_r_cpu_init", { tile1, tile2, x1, rp, x2, r, m, n}, expr((double) 0));
    computation buf_C_BB_i_cpu_init("buf_C_BB_i_cpu_init", { tile1, tile2, x1, rp, x2, r, m, n}, expr((double) 0));
    computation out_buf_C_BB_r_cpu_init("out_buf_C_BB_r_cpu_init", { rp, r, m, n}, expr((double) 0));
    computation out_buf_C_BB_i_cpu_init("out_buf_C_BB_i_cpu_init", { rp, r, m, n}, expr((double) 0));

    buffer buf_C_BB_r("buf_C_BB_r", { Lt, Vsnk / tiling_factor, Vsnk / tiling_factor, B2Nrows, Nsrc, B2Nrows, Nsnk}, p_float64, a_temporary);
    buffer buf_C_BB_i("buf_C_BB_i", { Lt, Vsnk / tiling_factor, Vsnk / tiling_factor, B2Nrows, Nsrc, B2Nrows, Nsnk}, p_float64, a_temporary);
    buffer buf_C_BB_r_cpu("buf_C_BB_r_cpu", { Lt, Vsnk / tiling_factor, Vsnk / tiling_factor, B2Nrows, Nsrc, B2Nrows, Nsnk}, p_float64, a_temporary);
    buffer buf_C_BB_i_cpu("buf_C_BB_i_cpu", { Lt, Vsnk / tiling_factor, Vsnk / tiling_factor, B2Nrows, Nsrc, B2Nrows, Nsnk}, p_float64, a_temporary);
    ...
    C_BB_init_r.store_in(&buf_C_BB_r, { TIME_SLICE, x1, x2, rp, m, r, n });
    C_BB_init_i.store_in(&buf_C_BB_i, { TIME_SLICE, x1, x2, rp, m, r, n });
    buf_C_BB_r_cpu_init.store_in( &buf_C_BB_r_cpu, { TIME_SLICE, x1, x2, rp, m, r, n } );
    buf_C_BB_i_cpu_init.store_in( &buf_C_BB_i_cpu, { TIME_SLICE, x1, x2, rp, m, r, n } );
    out_buf_C_BB_r_cpu_init.store_in( &out_buf_C_BB_r_cpu, { TIME_SLICE, rp, m, r, n } );
    out_buf_C_BB_i_cpu_init.store_in( &out_buf_C_BB_i_cpu, { TIME_SLICE, rp, m, r, n } );

    computation reduce_buf_C_BB_r_cpu("reduce_buf_C_BB_r_cpu", { tile1, tile2, x1, rp, x2, r, m, n}, p_float64);
    reduce_buf_C_BB_r_cpu.set_expression( reduce_buf_C_BB_r_cpu( tile1, tile2, x1, rp, x2, r, m, n) + buf_C_BB_r_cpu_init( tile1, tile2, x1, rp, x2, r, m, n ) );
    computation reduce_buf_C_BB_i_cpu("reduce_buf_C_BB_i_cpu", { tile1, tile2, x1, rp, x2, r, m, n}, p_float64);
    reduce_buf_C_BB_i_cpu.set_expression( reduce_buf_C_BB_i_cpu( tile1, tile2, x1, rp, x2, r, m, n) + buf_C_BB_i_cpu_init( tile1, tile2, x1, rp, x2, r, m, n ) );
    reduce_buf_C_BB_r_cpu.store_in( &out_buf_C_BB_r_cpu, { TIME_SLICE, rp, m, r, n } );
    reduce_buf_C_BB_i_cpu.store_in( &out_buf_C_BB_i_cpu, { TIME_SLICE, rp, m, r, n } );

    computation C_BB_BB_update_s_r("C_BB_BB_update_s_r", { tile1, tile2, x1, rp, x2, r, m, nue}, C_BB_init_r( tile1, tile2, x1, rp, x2, r, m, NEntangled+nue) + BB_BB_term_s.get_real());
    computation C_BB_BB_update_s_i("C_BB_BB_update_s_i", { tile1, tile2, x1, rp, x2, r, m, nue}, C_BB_init_i( tile1, tile2, x1, rp, x2, r, m, NEntangled+nue) + BB_BB_term_s.get_imag());

    computation C_BB_BB_update_b_r("C_BB_BB_update_b_r", { tile1, tile2, x1, rp, x2, r, m, ne}, C_BB_init_r( tile1, tile2, x1, rp, x2, r, m, ne) + BB_BB_term_b.get_real());
    computation C_BB_BB_update_b_i("C_BB_BB_update_b_i", { tile1, tile2, x1, rp, x2, r, m, ne}, C_BB_init_i( tile1, tile2, x1, rp, x2, r, m, ne) + BB_BB_term_b.get_imag());
    ...
    complex_expr H_H_B1_prop_0 = B1_prop( cast( p_int64, 0 ), TIME_SLICE, hex_snk_color_weights(r,nperm,wnumHex,0,0), hex_snk_spin_weights(r,nperm,wnumHex,0,0), hex_snk_color_weights(rp,0,wnumHexHex,0,0), hex_snk_spin_weights(rp,0,wnumHexHex,0,0), x_out*sites_per_rank+x_in, y);
    complex_expr H_H_B1_prop_2 = B1_prop( cast( p_int64, 2 ), TIME_SLICE, hex_snk_color_weights(r,nperm,wnumHex,2,0), hex_snk_spin_weights(r,nperm,wnumHex,2,0), hex_snk_color_weights(rp,0,wnumHexHex,2,0), hex_snk_spin_weights(rp,0,wnumHexHex,2,0), x_out*sites_per_rank+x_in, y);
    complex_expr H_H_B1_prop_1 = B1_prop( cast( p_int64, 1 ), TIME_SLICE, hex_snk_color_weights(r,nperm,wnumHex,1,0), hex_snk_spin_weights(r,nperm,wnumHex,1,0), hex_snk_color_weights(rp,0,wnumHexHex,1,0), hex_snk_spin_weights(rp,0,wnumHexHex,1,0), x_out*sites_per_rank+x_in, y);
    complex_expr B1_H = H_H_B1_prop_0 * H_H_B1_prop_2 * H_H_B1_prop_1;

    complex_expr H_H_B2_prop_0 = B2_prop(0, TIME_SLICE, hex_snk_color_weights(r,nperm,wnumHex,0,1), hex_snk_spin_weights(r,nperm,wnumHex,0,1), hex_snk_color_weights(rp,0,wnumHexHex,0,1), hex_snk_spin_weights(rp,0,wnumHexHex,0,1), x_out*sites_per_rank+x_in, y);
    complex_expr H_H_B2_prop_2 = B2_prop(2, TIME_SLICE, hex_snk_color_weights(r,nperm,wnumHex,2,1), hex_snk_spin_weights(r,nperm,wnumHex,2,1), hex_snk_color_weights(rp,0,wnumHexHex,2,1), hex_snk_spin_weights(rp,0,wnumHexHex,2,1), x_out*sites_per_rank+x_in, y);
    complex_expr H_H_B2_prop_1 = B2_prop(1, TIME_SLICE, hex_snk_color_weights(r,nperm,wnumHex,1,1), hex_snk_spin_weights(r,nperm,wnumHex,1,1), hex_snk_color_weights(rp,0,wnumHexHex,1,1), hex_snk_spin_weights(rp,0,wnumHexHex,1,1), x_out*sites_per_rank+x_in, y);
    ...
    src_B2_Blocal_r2_r_props_init.store_in(&buf_src_B2_Blocal_props_r2_r, {x_out, jCprime, jSprime, x_in});
    src_B2_Blocal_r2_i_props_init.store_in(&buf_src_B2_Blocal_props_r2_i, {x_out, jCprime, jSprime, x_in});
    src_B2_Blocal_r2_r_props.store_in(&buf_src_B2_Blocal_props_r2_r, {x_out, jCprime, jSprime, x_in});
    ...
    C_r.store_in(&buf_C_r, { TIME_SLICE, x_out, x_in, rp, mpmH, r, npnH });
    C_i.store_in(&buf_C_i, { TIME_SLICE, x_out, x_in, rp, mpmH, r, npnH });

    C_init_r.store_in(&buf_C_r, { TIME_SLICE, x_out, x_in, rp, mpmH, r, npnH});
    C_init_i.store_in(&buf_C_i, { TIME_SLICE, x_out, x_in, rp, mpmH, r, npnH});
    ...
    C_BB_BB_update_b_r.store_in(&buf_C_BB_r, { TIME_SLICE, x1, x2, rp, m, r, ne});
    C_BB_BB_update_b_i.store_in(&buf_C_BB_i, { TIME_SLICE, x1, x2, rp, m, r, ne});
    C_BB_BB_update_s_r.store_in(&buf_C_BB_r, { TIME_SLICE, x1, x2, rp, m, r, NEntangled+nue});
    C_BB_BB_update_s_i.store_in(&buf_C_BB_i, { TIME_SLICE, x1, x2, rp, m, r, NEntangled+nue});

    // BB_H

    buffer* buf_BB_H_new_term_r_b1;
    buffer* buf_BB_H_new_term_i_b1;
    allocate_complex_buffers(buf_BB_H_new_term_r_b1, buf_BB_H_new_term_i_b1, { Vsnk/sites_per_rank, sites_per_rank}, "buf_BB_H_new_term_b1", true);

    BB_H_new_term_0_r1_b1.get_real()->store_in(buf_BB_H_new_term_r_b1, { x_out, x_in});
    BB_H_new_term_0_r1_b1.get_imag()->store_in(buf_BB_H_new_term_i_b1, { x_out, x_in});

    BB_H_new_term_0_r2_b1.get_real()->store_in(buf_BB_H_new_term_r_b1, { x_out, x_in});
    BB_H_new_term_0_r2_b1.get_imag()->store_in(buf_BB_H_new_term_i_b1, { x_out, x_in});

    buffer* buf_BB_H_new_term_r_b2;
    buffer* buf_BB_H_new_term_i_b2;
    allocate_complex_buffers(buf_BB_H_new_term_r_b2, buf_BB_H_new_term_i_b2, { Vsnk/sites_per_rank, sites_per_rank}, "buf_BB_H_new_term_b2", true);

    BB_H_new_term_0_r1_b2.get_real()->store_in(buf_BB_H_new_term_r_b2, { x_out, x_in});
    BB_H_new_term_0_r1_b2.get_imag()->store_in(buf_BB_H_new_term_i_b2, { x_out, x_in});

    BB_H_new_term_0_r2_b2.get_real()->store_in(buf_BB_H_new_term_r_b2, { x_out, x_in});
    BB_H_new_term_0_r2_b2.get_imag()->store_in(buf_BB_H_new_term_i_b2, { x_out, x_in});

    buffer* buf_flip_BB_H_new_term_r_b1;
    buffer* buf_flip_BB_H_new_term_i_b1;
    allocate_complex_buffers(buf_flip_BB_H_new_term_r_b1, buf_flip_BB_H_new_term_i_b1, { Vsnk/sites_per_rank, sites_per_rank}, "buf_flip_BB_H_new_term_b1", true);

    flip_BB_H_new_term_0_r1_b1.get_real()->store_in(buf_flip_BB_H_new_term_r_b1, { x_out, x_in});
    flip_BB_H_new_term_0_r1_b1.get_imag()->store_in(buf_flip_BB_H_new_term_i_b1, { x_out, x_in});

    flip_BB_H_new_term_0_r2_b1.get_real()->store_in(buf_flip_BB_H_new_term_r_b1, { x_out, x_in});
    flip_BB_H_new_term_0_r2_b1.get_imag()->store_in(buf_flip_BB_H_new_term_i_b1, { x_out, x_in});

    buffer* buf_flip_BB_H_new_term_r_b2;
    buffer* buf_flip_BB_H_new_term_i_b2;
    allocate_complex_buffers(buf_flip_BB_H_new_term_r_b2, buf_flip_BB_H_new_term_i_b2, { Vsnk/sites_per_rank, sites_per_rank}, "buf_flip_BB_H_new_term_b2", true);

    flip_BB_H_new_term_0_r1_b2.get_real()->store_in(buf_flip_BB_H_new_term_r_b2, { x_out, x_in});
    flip_BB_H_new_term_0_r1_b2.get_imag()->store_in(buf_flip_BB_H_new_term_i_b2, { x_out, x_in});

    flip_BB_H_new_term_0_r2_b2.get_real()->store_in(buf_flip_BB_H_new_term_r_b2, { x_out, x_in});
    flip_BB_H_new_term_0_r2_b2.get_imag()->store_in(buf_flip_BB_H_new_term_i_b2, { x_out, x_in});


    buffer buf_C_BB_H_prop_r("buf_C_BB_H_prop_r", { Vsnk/sites_per_rank, sites_per_rank}, p_float64, a_temporary);
    buffer buf_C_BB_H_prop_i("buf_C_BB_H_prop_i", { Vsnk/sites_per_rank, sites_per_rank}, p_float64, a_temporary);
    buf_C_BB_H_prop_r.tag_gpu_global();
    buf_C_BB_H_prop_i.tag_gpu_global();

    C_BB_H_prop_init_r.store_in(&buf_C_BB_H_prop_r, { x_out, x_in});
    C_BB_H_prop_init_i.store_in(&buf_C_BB_H_prop_i, { x_out, x_in});
    C_BB_H_prop_update_r.store_in(&buf_C_BB_H_prop_r, { x_out, x_in});
    C_BB_H_prop_update_i.store_in(&buf_C_BB_H_prop_i, { x_out, x_in}); 

    C_BB_H_update_r.store_in(&buf_C_r, { TIME_SLICE, x_out, x_in, rp, m, r, Nsnk+nH});
    C_BB_H_update_i.store_in(&buf_C_i, { TIME_SLICE, x_out, x_in, rp, m, r, Nsnk+nH});

    // H_BB

    buffer* buf_H_BB_new_term_r_b1;
    buffer* buf_H_BB_new_term_i_b1;
    allocate_complex_buffers(buf_H_BB_new_term_r_b1, buf_H_BB_new_term_i_b1, { Vsnk/sites_per_rank, sites_per_rank, 1}, "buf_H_BB_new_term_b1", true);

    H_BB_new_term_0_r1_b1.get_real()->store_in(buf_H_BB_new_term_r_b1, { y_out, y_in, 0});
    H_BB_new_term_0_r1_b1.get_imag()->store_in(buf_H_BB_new_term_i_b1, { y_out, y_in, 0});

    H_BB_new_term_0_r2_b1.get_real()->store_in(buf_H_BB_new_term_r_b1, { y_out, y_in, 0});
    H_BB_new_term_0_r2_b1.get_imag()->store_in(buf_H_BB_new_term_i_b1, { y_out, y_in, 0});

    buffer* buf_H_BB_new_term_r_b2;
    buffer* buf_H_BB_new_term_i_b2;
    allocate_complex_buffers(buf_H_BB_new_term_r_b2, buf_H_BB_new_term_i_b2, { Vsnk/sites_per_rank, sites_per_rank, 1}, "buf_H_BB_new_term_b2", true);

    H_BB_new_term_0_r1_b2.get_real()->store_in(buf_H_BB_new_term_r_b2, { y_out, y_in, 0});
    H_BB_new_term_0_r1_b2.get_imag()->store_in(buf_H_BB_new_term_i_b2, { y_out, y_in, 0});

    H_BB_new_term_0_r2_b2.get_real()->store_in(buf_H_BB_new_term_r_b2, { y_out, y_in, 0});
    H_BB_new_term_0_r2_b2.get_imag()->store_in(buf_H_BB_new_term_i_b2, { y_out, y_in, 0});

    buffer* buf_flip_H_BB_new_term_r_b1;
    buffer* buf_flip_H_BB_new_term_i_b1;
    allocate_complex_buffers(buf_flip_H_BB_new_term_r_b1, buf_flip_H_BB_new_term_i_b1, { Vsnk/sites_per_rank, sites_per_rank, 1}, "buf_flip_H_BB_new_term_b1", true);

    flip_H_BB_new_term_0_r1_b1.get_real()->store_in(buf_flip_H_BB_new_term_r_b1, { y_out, y_in, 0});
    flip_H_BB_new_term_0_r1_b1.get_imag()->store_in(buf_flip_H_BB_new_term_i_b1, { y_out, y_in, 0});

    flip_H_BB_new_term_0_r2_b1.get_real()->store_in(buf_flip_H_BB_new_term_r_b1, { y_out, y_in, 0});
    flip_H_BB_new_term_0_r2_b1.get_imag()->store_in(buf_flip_H_BB_new_term_i_b1, { y_out, y_in, 0});

    buffer* buf_flip_H_BB_new_term_r_b2;
    buffer* buf_flip_H_BB_new_term_i_b2;
    allocate_complex_buffers(buf_flip_H_BB_new_term_r_b2, buf_flip_H_BB_new_term_i_b2, { Vsnk/sites_per_rank, sites_per_rank, 1}, "buf_flip_H_BB_new_term_b2", true);

    flip_H_BB_new_term_0_r1_b2.get_real()->store_in(buf_flip_H_BB_new_term_r_b2, { y_out, y_in, 0});
    flip_H_BB_new_term_0_r1_b2.get_imag()->store_in(buf_flip_H_BB_new_term_i_b2, { y_out, y_in, 0});

    flip_H_BB_new_term_0_r2_b2.get_real()->store_in(buf_flip_H_BB_new_term_r_b2, { y_out, y_in, 0});
    flip_H_BB_new_term_0_r2_b2.get_imag()->store_in(buf_flip_H_BB_new_term_i_b2, { y_out, y_in, 0});

    buffer buf_C_H_BB_prop_r("buf_C_H_BB_prop_r", { Vsnk/sites_per_rank, sites_per_rank, 1}, p_float64, a_temporary);
    buffer buf_C_H_BB_prop_i("buf_C_H_BB_prop_i", { Vsnk/sites_per_rank, sites_per_rank, 1}, p_float64, a_temporary);
    buf_C_H_BB_prop_r.tag_gpu_global();
    buf_C_H_BB_prop_i.tag_gpu_global();

    C_H_BB_prop_init_r.store_in(&buf_C_H_BB_prop_r, { y_out, y_in, 0});
    C_H_BB_prop_init_i.store_in(&buf_C_H_BB_prop_i, { y_out, y_in, 0});
    C_H_BB_prop_update_r.store_in(&buf_C_H_BB_prop_r, { y_out, y_in, 0});
    C_H_BB_prop_update_i.store_in(&buf_C_H_BB_prop_i, { y_out, y_in, 0});

    buffer buff_H_BB_term_res_comp_r("buff_H_BB_term_res_comp_r", { Vsnk/sites_per_rank, sites_per_rank, 1}, p_float64, a_temporary);
    buffer buff_H_BB_term_res_comp_i("buff_H_BB_term_res_comp_i", { Vsnk/sites_per_rank, sites_per_rank, 1}, p_float64, a_temporary);
    buff_H_BB_term_res_comp_r.tag_gpu_global();
    buff_H_BB_term_res_comp_i.tag_gpu_global();

    H_BB_term_res_comp.get_imag()->store_in( &buff_H_BB_term_res_comp_r, { y_out, y_in, 0 } );
    H_BB_term_res_comp.get_real()->store_in( &buff_H_BB_term_res_comp_i, { y_out, y_in, 0 } );

    C_H_BB_update_r.store_in(&buf_C_r, { TIME_SLICE, y_out, y_in, rp, Nsrc+mH, r, n});
    C_H_BB_update_i.store_in(&buf_C_i, { TIME_SLICE, y_out, y_in, rp, Nsrc+mH, r, n});

    // H_H

    buffer buf_C_H_H_prop_r("buf_C_H_H_prop_r", { Vsnk/sites_per_rank, sites_per_rank, 1}, p_float64, a_temporary);
    buffer buf_C_H_H_prop_i("buf_C_H_H_prop_i", { Vsnk/sites_per_rank, sites_per_rank, 1}, p_float64, a_temporary);
    ...
    C_H_H_update_r.store_in(&buf_C_r, { TIME_SLICE, x_out, x_in, rp, Nsrc+mH, r, Nsnk+nH});
    C_H_H_update_i.store_in(&buf_C_i, { TIME_SLICE, x_out, x_in, rp, Nsrc+mH, r, Nsnk+nH});  
...
// kernel_11:
    ...
    tiramisu::codegen({
        ...
        "generated_gpu_tiramisu_make_fused_dibaryon_blocks_correlator_single_time_slice.o", true);
}

int main(int argc, char **argv)
{
	generate_function("gpu_tiramisu_make_fused_dibaryon_blocks_correlator_single_time_slice");
