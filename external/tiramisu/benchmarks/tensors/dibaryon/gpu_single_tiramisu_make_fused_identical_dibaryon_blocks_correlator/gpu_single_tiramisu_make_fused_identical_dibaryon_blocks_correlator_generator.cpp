...
void generate_function(std::string name)
{
    ...
    input C_r("C_r",      {t, x_out, x_in, rp, mpmH, r, npnH}, p_float32);
    input C_i("C_i",      {t, x_out, x_in, rp, mpmH, r, npnH}, p_float32);
    buffer buf_C_r_cpu("C_r", {Lt, Vsnk/sites_per_rank, sites_per_rank, B2Nrows, NsrcTot, B2Nrows, NsnkTot}, p_float32, a_temporary);
    buffer buf_C_i_cpu("C_i", {Lt, Vsnk/sites_per_rank, sites_per_rank, B2Nrows, NsrcTot, B2Nrows, NsnkTot}, p_float32, a_temporary);
    ...
    buffer buf_B1_prop_r_gpu("buf_B1_prop_r_gpu",   {Lt, Nc, Ns, Nc, Ns, Vsnk, Vsrc}, p_float32, a_temporary);
    buffer buf_B1_prop_i_gpu("buf_B1_prop_i_gpu",   {Lt, Nc, Ns, Nc, Ns, Vsnk, Vsrc}, p_float32, a_temporary);
    buf_B1_prop_r_gpu.tag_gpu_global();
    buf_B1_prop_i_gpu.tag_gpu_global();
    B1_prop_r.store_in( &buf_B1_prop_r_gpu, {t, iCprime, iSprime, jCprime, jSprime, x, y} );
    B1_prop_i.store_in( &buf_B1_prop_i_gpu, {t, iCprime, iSprime, jCprime, jSprime, x, y} );
    buffer buf_B1_prop_r_cpu("B1_prop_r",   {Lt, Nc, Ns, Nc, Ns, Vsnk, Vsrc}, p_float32, a_temporary);
    buffer buf_B1_prop_i_cpu("B1_prop_i",   {Lt, Nc, Ns, Nc, Ns, Vsnk, Vsrc}, p_float32, a_temporary);

    input src_psi_B1_r("src_psi_B1_r",    {y, m}, p_float32);
    input src_psi_B1_i("src_psi_B1_i",    {y, m}, p_float32);
    input src_psi_B2_r("src_psi_B2_r",    {y, m}, p_float32);
    input src_psi_B2_i("src_psi_B2_i",    {y, m}, p_float32);
    input snk_psi_B1_r("snk_psi_B1_r",    {x, n}, p_float32);
    input snk_psi_B1_i("snk_psi_B1_i",    {x, n}, p_float32);
    input snk_psi_B2_r("snk_psi_B2_r",    {x, n}, p_float32);
    input snk_psi_B2_i("snk_psi_B2_i",    {x, n}, p_float32);
    input hex_src_psi_r("hex_src_psi_r",    {y, mH}, p_float32);
    input hex_src_psi_i("hex_src_psi_i",    {y, mH}, p_float32);
    input hex_snk_psi_r("hex_snk_psi_r",    {x, nH}, p_float32);
    input hex_snk_psi_i("hex_snk_psi_i",    {x, nH}, p_float32);
    input snk_psi_r("snk_psi_r", {x, x2, ne}, p_float32);
    input snk_psi_i("snk_psi_i", {x, x2, ne}, p_float32);
    buffer buf_src_psi_B1_r_gpu("buf_src_psi_B1_r_gpu",   {Vsrc, Nsrc}, p_float32, a_temporary);
    buffer buf_src_psi_B1_i_gpu("buf_src_psi_B1_i_gpu",   {Vsrc, Nsrc}, p_float32, a_temporary);
    buffer buf_src_psi_B2_r_gpu("buf_src_psi_B2_r_gpu",   {Vsrc, Nsrc}, p_float32, a_temporary);
    buffer buf_src_psi_B2_i_gpu("buf_src_psi_B2_i_gpu",   {Vsrc, Nsrc}, p_float32, a_temporary);
    buffer buf_snk_psi_B1_r_gpu("buf_snk_psi_B1_r_gpu",   {Vsnk, Nsnk}, p_float32, a_temporary);
    buffer buf_snk_psi_B1_i_gpu("buf_snk_psi_B1_i_gpu",   {Vsnk, Nsnk}, p_float32, a_temporary);
    buffer buf_snk_psi_B2_r_gpu("buf_snk_psi_B2_r_gpu",   {Vsnk, Nsnk}, p_float32, a_temporary);
    buffer buf_snk_psi_B2_i_gpu("buf_snk_psi_B2_i_gpu",   {Vsnk, Nsnk}, p_float32, a_temporary);
    buffer buf_hex_src_psi_r_gpu("buf_hex_src_psi_r_gpu",   {Vsrc, NsrcHex}, p_float32, a_temporary);
    buffer buf_hex_src_psi_i_gpu("buf_hex_src_psi_i_gpu",   {Vsrc, NsrcHex}, p_float32, a_temporary);
    buffer buf_hex_snk_psi_r_gpu("buf_hex_snk_psi_r_gpu",   {Vsnk, NsnkHex}, p_float32, a_temporary);
    buffer buf_hex_snk_psi_i_gpu("buf_hex_snk_psi_i_gpu",   {Vsnk, NsnkHex}, p_float32, a_temporary);
    buffer buf_snk_psi_r_gpu("buf_snk_psi_r_gpu",   {Vsnk, Vsnk, NEntangled}, p_float32, a_temporary);
    buffer buf_snk_psi_i_gpu("buf_snk_psi_i_gpu",   {Vsnk, Vsnk, NEntangled}, p_float32, a_temporary);
    ...
    buffer buf_src_psi_B1_r_cpu("src_psi_B1_r",   {Vsrc, Nsrc}, p_float32, a_temporary);
    buffer buf_src_psi_B1_i_cpu("src_psi_B1_i",   {Vsrc, Nsrc}, p_float32, a_temporary);
    buffer buf_src_psi_B2_r_cpu("src_psi_B2_r",   {Vsrc, Nsrc}, p_float32, a_temporary);
    buffer buf_src_psi_B2_i_cpu("src_psi_B2_i",   {Vsrc, Nsrc}, p_float32, a_temporary);
    buffer buf_snk_psi_B1_r_cpu("snk_psi_B1_r",   {Vsnk, Nsnk}, p_float32, a_temporary);
    buffer buf_snk_psi_B1_i_cpu("snk_psi_B1_i",   {Vsnk, Nsnk}, p_float32, a_temporary);
    buffer buf_snk_psi_B2_r_cpu("snk_psi_B2_r",   {Vsnk, Nsnk}, p_float32, a_temporary);
    buffer buf_snk_psi_B2_i_cpu("snk_psi_B2_i",   {Vsnk, Nsnk}, p_float32, a_temporary);
    buffer buf_hex_src_psi_r_cpu("hex_src_psi_r",   {Vsrc, NsrcHex}, p_float32, a_temporary);
    buffer buf_hex_src_psi_i_cpu("hex_src_psi_i",   {Vsrc, NsrcHex}, p_float32, a_temporary);
    buffer buf_hex_snk_psi_r_cpu("hex_snk_psi_r",   {Vsnk, NsnkHex}, p_float32, a_temporary);
    buffer buf_hex_snk_psi_i_cpu("hex_snk_psi_i",   {Vsnk, NsnkHex}, p_float32, a_temporary);
    buffer buf_snk_psi_r_cpu("snk_psi_r",   {Vsnk, Vsnk, NEntangled}, p_float32, a_temporary);
    buffer buf_snk_psi_i_cpu("snk_psi_i",   {Vsnk, Vsnk, NEntangled}, p_float32, a_temporary);

    input src_spins("src_spins", {rp, s, to}, p_int32);
    input src_spin_block_weights("src_spin_block_weights", {rp, s}, p_float32);
    ...
    input src_weights("src_weights", {r, wnumBlock}, p_float32);
    ...
    input hex_snk_weights("hex_snk_weights", {r, wnumHex}, p_float32);

    buffer buf_src_spins_gpu("src_spins",   {B2Nrows, 2, 2}, p_int32, a_temporary);
    buffer buf_src_spin_block_weights_gpu("buf_src_spin_block_weights_gpu",   {B2Nrows, 2}, p_float32, a_temporary);
    ...
    buffer buf_src_weights_gpu("buf_src_weights_gpu",   {B2Nrows, Nw}, p_float32, a_temporary);
    ...
    buffer buf_snk_weights_gpu("buf_snk_weights_gpu",   {B2Nrows, Nw2}, p_float32, a_temporary);
    ...
    buffer buf_hex_snk_weights_gpu("buf_hex_snk_weights_gpu", {B2Nrows, Nw2Hex}, p_float32, a_temporary);
    ...
    buffer buf_src_spin_block_weights_cpu("src_spin_block_weights",   {B2Nrows, 2}, p_float32, a_temporary);
    ...
    buffer buf_src_weights_cpu("src_weights",   {B2Nrows, Nw}, p_float32, a_temporary);
    ...
    buffer buf_snk_weights_cpu("snk_weights",   {B2Nrows, Nw2}, p_float32, a_temporary);
    ...
    buffer buf_hex_snk_weights_cpu("hex_snk_weights", {B2Nrows, Nw2Hex}, p_float32, a_temporary);
    ...
    computation B1_Blocal_r1_r_init("B1_Blocal_r1_r_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation B1_Blocal_r1_i_init("B1_Blocal_r1_i_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation B1_Bfirst_r1_r_init("B1_Bfirst_r1_r_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation B1_Bfirst_r1_i_init("B1_Bfirst_r1_i_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation B1_Bsecond_r1_r_init("B1_Bsecond_r1_r_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation B1_Bsecond_r1_i_init("B1_Bsecond_r1_i_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation B1_Bthird_r1_r_init("B1_Bthird_r1_r_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation B1_Bthird_r1_i_init("B1_Bthird_r1_i_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    ...
    computation flip_B1_Blocal_r1_r_init("flip_B1_Blocal_r1_r_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation flip_B1_Blocal_r1_i_init("flip_B1_Blocal_r1_i_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation flip_B1_Bfirst_r1_r_init("flip_B1_Bfirst_r1_r_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation flip_B1_Bfirst_r1_i_init("flip_B1_Bfirst_r1_i_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation flip_B1_Bsecond_r1_r_init("flip_B1_Bsecond_r1_r_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation flip_B1_Bsecond_r1_i_init("flip_B1_Bsecond_r1_i_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation flip_B1_Bthird_r1_r_init("flip_B1_Bthird_r1_r_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation flip_B1_Bthird_r1_i_init("flip_B1_Bthird_r1_i_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    ...
    complex_expr B1_r1_prop_0 =  B1_prop(t, iCprime, iSprime, src_color_weights(0, wnumBlock, 0), src_spin_weights(0, wnumBlock, 0), x1 * tiling_factor + tile1, y);
    complex_expr B1_r1_prop_1 = B1_prop(t, jCprime, jSprime, src_color_weights(0, wnumBlock, 1), src_spin_weights(0, wnumBlock, 1), x1 * tiling_factor + tile1, y);
    complex_expr B1_r1_prop_2 =  B1_prop(t, kCprime, kSprime, src_color_weights(0, wnumBlock, 2), src_spin_weights(0, wnumBlock, 2), x1 * tiling_factor + tile1, y);
    complex_expr first_B1_r1_prop_0 =  B1_prop(t, iCprime, iSprime, src_color_weights(0, wnumBlock, 0), src_spin_weights(0, wnumBlock, 0), x2 * tiling_factor + tile2, y);
    complex_expr second_B1_r1_prop_1 = B1_prop(t, jCprime, jSprime, src_color_weights(0, wnumBlock, 1), src_spin_weights(0, wnumBlock, 1), x2 * tiling_factor + tile2, y);
    complex_expr third_B1_r1_prop_2 =  B1_prop(t, kCprime, kSprime, src_color_weights(0, wnumBlock, 2), src_spin_weights(0, wnumBlock, 2), x2 * tiling_factor + tile2, y);
    ...
    computation B1_Blocal_r1_r_props_init("B1_Blocal_r1_r_props_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    computation B1_Blocal_r1_i_props_init("B1_Blocal_r1_i_props_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    computation B1_Bfirst_r1_r_props_init("B1_Bfirst_r1_r_props_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    computation B1_Bfirst_r1_i_props_init("B1_Bfirst_r1_i_props_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    computation B1_Bsecond_r1_r_props_init("B1_Bsecond_r1_r_props_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    computation B1_Bsecond_r1_i_props_init("B1_Bsecond_r1_i_props_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    computation B1_Bthird_r1_r_props_init("B1_Bthird_r1_r_props_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    computation B1_Bthird_r1_i_props_init("B1_Bthird_r1_i_props_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));

    computation B1_Blocal_r1_r_diquark("B1_Blocal_r1_r_diquark", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock}, B1_r1_diquark.get_real());
    computation B1_Blocal_r1_i_diquark("B1_Blocal_r1_i_diquark", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock}, B1_r1_diquark.get_imag());
    computation B1_Bfirst_r1_r_diquark("B1_Bfirst_r1_r_diquark", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock}, first_B1_r1_diquark.get_real());
    computation B1_Bfirst_r1_i_diquark("B1_Bfirst_r1_i_diquark", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock}, first_B1_r1_diquark.get_imag());
    computation B1_Bthird_r1_r_diquark("B1_Bthird_r1_r_diquark", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock}, third_B1_r1_diquark.get_real());
    computation B1_Bthird_r1_i_diquark("B1_Bthird_r1_i_diquark", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock}, third_B1_r1_diquark.get_imag());
    ...
    complex_expr B1_r1_props = B1_r1_prop_1 * B1_Blocal_r1_diquark(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock);
    complex_expr first_B1_r1_props = B1_r1_prop_1 * B1_Bfirst_r1_diquark(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock);
    complex_expr second_B1_r1_props = second_B1_r1_prop_1 * B1_Blocal_r1_diquark(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock);
    complex_expr third_B1_r1_props = B1_r1_prop_1 * B1_Bthird_r1_diquark(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock);

    computation B1_Blocal_r1_r_props("B1_Blocal_r1_r_props", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock, jCprime, jSprime}, B1_Blocal_r1_r_props_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime) + B1_r1_props.get_real());
    computation B1_Blocal_r1_i_props("B1_Blocal_r1_i_props", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock, jCprime, jSprime}, B1_Blocal_r1_i_props_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime) + B1_r1_props.get_imag());
    computation B1_Bfirst_r1_r_props("B1_Bfirst_r1_r_props", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock, jCprime, jSprime}, B1_Bfirst_r1_r_props_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime) + first_B1_r1_props.get_real());
    computation B1_Bfirst_r1_i_props("B1_Bfirst_r1_i_props", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock, jCprime, jSprime}, B1_Bfirst_r1_i_props_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime) + first_B1_r1_props.get_imag());
    computation B1_Bsecond_r1_r_props("B1_Bsecond_r1_r_props", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock, jCprime, jSprime}, B1_Bsecond_r1_r_props_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime) + second_B1_r1_props.get_real());
    computation B1_Bsecond_r1_i_props("B1_Bsecond_r1_i_props", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock, jCprime, jSprime}, B1_Bsecond_r1_i_props_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime) + second_B1_r1_props.get_imag());
    computation B1_Bthird_r1_r_props("B1_Bthird_r1_r_props", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock, jCprime, jSprime}, B1_Bthird_r1_r_props_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime) + third_B1_r1_props.get_real());
    computation B1_Bthird_r1_i_props("B1_Bthird_r1_i_props", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock, jCprime, jSprime}, B1_Bthird_r1_i_props_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime) + third_B1_r1_props.get_imag());
    ...
    complex_expr B1_r1 = src_psi_B1 * B1_Blocal_r1_props(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, Nw-1, jCprime, jSprime);
    complex_expr first_B1_r1 = src_psi_B1 * B1_Bfirst_r1_props(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, Nw-1, jCprime, jSprime);
    complex_expr second_B1_r1 = src_psi_B1 * B1_Bsecond_r1_props(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, Nw-1, jCprime, jSprime);
    complex_expr third_B1_r1 = src_psi_B1 * B1_Bthird_r1_props(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, Nw-1, jCprime, jSprime);

    computation B1_Blocal_r1_r_update("B1_Blocal_r1_r_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, B1_Blocal_r1_r_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + B1_r1.get_real());
    computation B1_Blocal_r1_i_update("B1_Blocal_r1_i_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, B1_Blocal_r1_i_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + B1_r1.get_imag());
    computation B1_Bfirst_r1_r_update("B1_Bfirst_r1_r_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, B1_Bfirst_r1_r_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + first_B1_r1.get_real());
    computation B1_Bfirst_r1_i_update("B1_Bfirst_r1_i_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, B1_Bfirst_r1_i_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + first_B1_r1.get_imag()); 
    computation B1_Bsecond_r1_r_update("B1_Bsecond_r1_r_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, B1_Bsecond_r1_r_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + second_B1_r1.get_real());
    computation B1_Bsecond_r1_i_update("B1_Bsecond_r1_i_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, B1_Bsecond_r1_i_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + second_B1_r1.get_imag());
    computation B1_Bthird_r1_r_update("B1_Bthird_r1_r_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, B1_Bthird_r1_r_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + third_B1_r1.get_real());
    computation B1_Bthird_r1_i_update("B1_Bthird_r1_i_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, B1_Bthird_r1_i_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + third_B1_r1.get_imag()); 

    complex_expr flip_B1_r1 = src_psi_B2 * B1_Blocal_r1_props(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, Nw-1, jCprime, jSprime);
    complex_expr flip_first_B1_r1 = src_psi_B2 * B1_Bfirst_r1_props(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, Nw-1, jCprime, jSprime);
    complex_expr flip_second_B1_r1 = src_psi_B2 * B1_Bsecond_r1_props(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, Nw-1, jCprime, jSprime);
    complex_expr flip_third_B1_r1 = src_psi_B2 * B1_Bthird_r1_props(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, Nw-1, jCprime, jSprime);

    computation flip_B1_Blocal_r1_r_update("flip_B1_Blocal_r1_r_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, flip_B1_Blocal_r1_r_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + flip_B1_r1.get_real());
    computation flip_B1_Blocal_r1_i_update("flip_B1_Blocal_r1_i_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, flip_B1_Blocal_r1_i_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + flip_B1_r1.get_imag());
    computation flip_B1_Bfirst_r1_r_update("flip_B1_Bfirst_r1_r_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, flip_B1_Bfirst_r1_r_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + flip_first_B1_r1.get_real());
    computation flip_B1_Bfirst_r1_i_update("flip_B1_Bfirst_r1_i_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, flip_B1_Bfirst_r1_i_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + flip_first_B1_r1.get_imag()); 
    computation flip_B1_Bsecond_r1_r_update("flip_B1_Bsecond_r1_r_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, flip_B1_Bsecond_r1_r_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + flip_second_B1_r1.get_real());
    computation flip_B1_Bsecond_r1_i_update("flip_B1_Bsecond_r1_i_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, flip_B1_Bsecond_r1_i_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + flip_second_B1_r1.get_imag());
    computation flip_B1_Bthird_r1_r_update("flip_B1_Bthird_r1_r_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, flip_B1_Bthird_r1_r_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + flip_third_B1_r1.get_real());
    computation flip_B1_Bthird_r1_i_update("flip_B1_Bthird_r1_i_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, flip_B1_Bthird_r1_i_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + flip_third_B1_r1.get_imag()); 

     // Computing B1_Blocal_r2, B1_Bsecond_r2, B1_Bfirst_r2

    computation B1_Blocal_r2_r_init("B1_Blocal_r2_r_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation B1_Blocal_r2_i_init("B1_Blocal_r2_i_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation B1_Bfirst_r2_r_init("B1_Bfirst_r2_r_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation B1_Bfirst_r2_i_init("B1_Bfirst_r2_i_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation B1_Bsecond_r2_r_init("B1_Bsecond_r2_r_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation B1_Bsecond_r2_i_init("B1_Bsecond_r2_i_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation B1_Bthird_r2_r_init("B1_Bthird_r2_r_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation B1_Bthird_r2_i_init("B1_Bthird_r2_i_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    ...
    computation flip_B1_Blocal_r2_r_init("flip_B1_Blocal_r2_r_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation flip_B1_Blocal_r2_i_init("flip_B1_Blocal_r2_i_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation flip_B1_Bfirst_r2_r_init("flip_B1_Bfirst_r2_r_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation flip_B1_Bfirst_r2_i_init("flip_B1_Bfirst_r2_i_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation flip_B1_Bsecond_r2_r_init("flip_B1_Bsecond_r2_r_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation flip_B1_Bsecond_r2_i_init("flip_B1_Bsecond_r2_i_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation flip_B1_Bthird_r2_r_init("flip_B1_Bthird_r2_r_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation flip_B1_Bthird_r2_i_init("flip_B1_Bthird_r2_i_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    ...
    complex_expr B1_r2_prop_0 =  B1_prop(t, iCprime, iSprime, src_color_weights(1, wnumBlock, 0), src_spin_weights(1, wnumBlock, 0), x1 * tiling_factor + tile1, y);
    complex_expr B1_r2_prop_2 =  B1_prop(t, kCprime, kSprime, src_color_weights(1, wnumBlock, 2), src_spin_weights(1, wnumBlock, 2), x1 * tiling_factor + tile1, y);
    complex_expr B1_r2_prop_1 = B1_prop(t, jCprime, jSprime, src_color_weights(1, wnumBlock, 1), src_spin_weights(1, wnumBlock, 1), x1 * tiling_factor + tile1, y);
    complex_expr first_B1_r2_prop_0 =  B1_prop(t, iCprime, iSprime, src_color_weights(1, wnumBlock, 0), src_spin_weights(1, wnumBlock, 0), x2 * tiling_factor + tile2, y);
    complex_expr second_B1_r2_prop_1 = B1_prop(t, jCprime, jSprime, src_color_weights(1, wnumBlock, 1), src_spin_weights(1, wnumBlock, 1), x2 * tiling_factor + tile2, y);
    complex_expr third_B1_r2_prop_2 =  B1_prop(t, kCprime, kSprime, src_color_weights(1, wnumBlock, 2), src_spin_weights(1, wnumBlock, 2), x2 * tiling_factor + tile2, y);
    ...
    computation B1_Blocal_r2_r_props_init("B1_Blocal_r2_r_props_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    computation B1_Blocal_r2_i_props_init("B1_Blocal_r2_i_props_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    computation B1_Bfirst_r2_r_props_init("B1_Bfirst_r2_r_props_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    computation B1_Bfirst_r2_i_props_init("B1_Bfirst_r2_i_props_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    computation B1_Bsecond_r2_r_props_init("B1_Bsecond_r2_r_props_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    computation B1_Bsecond_r2_i_props_init("B1_Bsecond_r2_i_props_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    computation B1_Bthird_r2_r_props_init("B1_Bthird_r2_r_props_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    computation B1_Bthird_r2_i_props_init("B1_Bthird_r2_i_props_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));

    computation B1_Blocal_r2_r_diquark("B1_Blocal_r2_r_diquark", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock}, B1_r2_diquark.get_real());
    computation B1_Blocal_r2_i_diquark("B1_Blocal_r2_i_diquark", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock}, B1_r2_diquark.get_imag());
    computation B1_Bfirst_r2_r_diquark("B1_Bfirst_r2_r_diquark", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock}, first_B1_r2_diquark.get_real());
    computation B1_Bfirst_r2_i_diquark("B1_Bfirst_r2_i_diquark", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock}, first_B1_r2_diquark.get_imag());
    computation B1_Bthird_r2_r_diquark("B1_Bthird_r2_r_diquark", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock}, third_B1_r2_diquark.get_real());
    computation B1_Bthird_r2_i_diquark("B1_Bthird_r2_i_diquark", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock}, third_B1_r2_diquark.get_imag());
    ...
    complex_expr B1_r2_props = B1_r2_prop_1 * B1_Blocal_r2_diquark(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock);
    complex_expr first_B1_r2_props = B1_r2_prop_1 * B1_Bfirst_r2_diquark(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock);
    complex_expr second_B1_r2_props = second_B1_r2_prop_1 * B1_Blocal_r2_diquark(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock);
    complex_expr third_B1_r2_props = B1_r2_prop_1 * B1_Bthird_r2_diquark(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock);

    computation B1_Blocal_r2_r_props("B1_Blocal_r2_r_props", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock, jCprime, jSprime}, B1_Blocal_r2_r_props_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime) + B1_r2_props.get_real());
    computation B1_Blocal_r2_i_props("B1_Blocal_r2_i_props", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock, jCprime, jSprime}, B1_Blocal_r2_i_props_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime) + B1_r2_props.get_imag());
    computation B1_Bfirst_r2_r_props("B1_Bfirst_r2_r_props", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock, jCprime, jSprime}, B1_Bfirst_r2_r_props_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime) + first_B1_r2_props.get_real());
    computation B1_Bfirst_r2_i_props("B1_Bfirst_r2_i_props", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock, jCprime, jSprime}, B1_Bfirst_r2_i_props_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime) + first_B1_r2_props.get_imag());
    computation B1_Bsecond_r2_r_props("B1_Bsecond_r2_r_props", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock, jCprime, jSprime}, B1_Bsecond_r2_r_props_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime) + second_B1_r2_props.get_real());
    computation B1_Bsecond_r2_i_props("B1_Bsecond_r2_i_props", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock, jCprime, jSprime}, B1_Bsecond_r2_i_props_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime) + second_B1_r2_props.get_imag());
    computation B1_Bthird_r2_r_props("B1_Bthird_r2_r_props", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock, jCprime, jSprime}, B1_Bthird_r2_r_props_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime) + third_B1_r2_props.get_real());
    computation B1_Bthird_r2_i_props("B1_Bthird_r2_i_props", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock, jCprime, jSprime}, B1_Bthird_r2_i_props_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime) + third_B1_r2_props.get_imag());
    ...
    complex_expr B1_r2 = src_psi_B1 * B1_Blocal_r2_props(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, Nw-1, jCprime, jSprime);
    complex_expr first_B1_r2 = src_psi_B1 * B1_Bfirst_r2_props(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, Nw-1, jCprime, jSprime);
    complex_expr second_B1_r2 = src_psi_B1 * B1_Bsecond_r2_props(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, Nw-1, jCprime, jSprime);
    complex_expr third_B1_r2 = src_psi_B1 * B1_Bthird_r2_props(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, Nw-1, jCprime, jSprime);

    computation B1_Blocal_r2_r_update("B1_Blocal_r2_r_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, B1_Blocal_r2_r_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + B1_r2.get_real());
    computation B1_Blocal_r2_i_update("B1_Blocal_r2_i_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, B1_Blocal_r2_i_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + B1_r2.get_imag());
    computation B1_Bfirst_r2_r_update("B1_Bfirst_r2_r_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, B1_Bfirst_r2_r_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + first_B1_r2.get_real());
    computation B1_Bfirst_r2_i_update("B1_Bfirst_r2_i_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, B1_Bfirst_r2_i_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + first_B1_r2.get_imag());
    computation B1_Bsecond_r2_r_update("B1_Bsecond_r2_r_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, B1_Bsecond_r2_r_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + second_B1_r2.get_real());
    computation B1_Bsecond_r2_i_update("B1_Bsecond_r2_i_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, B1_Bsecond_r2_i_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + second_B1_r2.get_imag());
    computation B1_Bthird_r2_r_update("B1_Bthird_r2_r_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, B1_Bthird_r2_r_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + third_B1_r2.get_real());
    computation B1_Bthird_r2_i_update("B1_Bthird_r2_i_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, B1_Bthird_r2_i_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + third_B1_r2.get_imag());

    complex_expr flip_B1_r2 = src_psi_B2 * B1_Blocal_r2_props(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, Nw-1, jCprime, jSprime);
    complex_expr flip_first_B1_r2 = src_psi_B2 * B1_Bfirst_r2_props(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, Nw-1, jCprime, jSprime);
    complex_expr flip_second_B1_r2 = src_psi_B2 * B1_Bsecond_r2_props(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, Nw-1, jCprime, jSprime);
    complex_expr flip_third_B1_r2 = src_psi_B2 * B1_Bthird_r2_props(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, Nw-1, jCprime, jSprime);

    computation flip_B1_Blocal_r2_r_update("flip_B1_Blocal_r2_r_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, flip_B1_Blocal_r2_r_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + flip_B1_r2.get_real());
    computation flip_B1_Blocal_r2_i_update("flip_B1_Blocal_r2_i_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, flip_B1_Blocal_r2_i_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + flip_B1_r2.get_imag());
    computation flip_B1_Bfirst_r2_r_update("flip_B1_Bfirst_r2_r_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, flip_B1_Bfirst_r2_r_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + flip_first_B1_r2.get_real());
    computation flip_B1_Bfirst_r2_i_update("flip_B1_Bfirst_r2_i_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, flip_B1_Bfirst_r2_i_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + flip_first_B1_r2.get_imag()); 
    computation flip_B1_Bsecond_r2_r_update("flip_B1_Bsecond_r2_r_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, flip_B1_Bsecond_r2_r_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + flip_second_B1_r2.get_real());
    computation flip_B1_Bsecond_r2_i_update("flip_B1_Bsecond_r2_i_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, flip_B1_Bsecond_r2_i_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + flip_second_B1_r2.get_imag());
    computation flip_B1_Bthird_r2_r_update("flip_B1_Bthird_r2_r_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, flip_B1_Bthird_r2_r_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + flip_third_B1_r2.get_real());
    computation flip_B1_Bthird_r2_i_update("flip_B1_Bthird_r2_i_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, flip_B1_Bthird_r2_i_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + flip_third_B1_r2.get_imag()); 

     //Computing B2_Blocal_r1, B2_Bsecond_r1, B2_Bfirst_r1

    computation B2_Blocal_r1_r_init("B2_Blocal_r1_r_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation B2_Blocal_r1_i_init("B2_Blocal_r1_i_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation B2_Bfirst_r1_r_init("B2_Bfirst_r1_r_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation B2_Bfirst_r1_i_init("B2_Bfirst_r1_i_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation B2_Bsecond_r1_r_init("B2_Bsecond_r1_r_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation B2_Bsecond_r1_i_init("B2_Bsecond_r1_i_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation B2_Bthird_r1_r_init("B2_Bthird_r1_r_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation B2_Bthird_r1_i_init("B2_Bthird_r1_i_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    ...
    computation flip_B2_Blocal_r1_r_init("flip_B2_Blocal_r1_r_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation flip_B2_Blocal_r1_i_init("flip_B2_Blocal_r1_i_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation flip_B2_Bfirst_r1_r_init("flip_B2_Bfirst_r1_r_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation flip_B2_Bfirst_r1_i_init("flip_B2_Bfirst_r1_i_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation flip_B2_Bsecond_r1_r_init("flip_B2_Bsecond_r1_r_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation flip_B2_Bsecond_r1_i_init("flip_B2_Bsecond_r1_i_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation flip_B2_Bthird_r1_r_init("flip_B2_Bthird_r1_r_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation flip_B2_Bthird_r1_i_init("flip_B2_Bthird_r1_i_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    ...
    complex_expr B2_r1_prop_0 =  B1_prop(t, iCprime, iSprime, src_color_weights(0, wnumBlock, 0), src_spin_weights(0, wnumBlock, 0), x2 * tiling_factor + tile2, y);
    complex_expr B2_r1_prop_2 =  B1_prop(t, kCprime, kSprime, src_color_weights(0, wnumBlock, 2), src_spin_weights(0, wnumBlock, 2), x2 * tiling_factor + tile2, y);
    complex_expr B2_r1_prop_1 = B1_prop(t, jCprime, jSprime, src_color_weights(0, wnumBlock, 1), src_spin_weights(0, wnumBlock, 1), x2 * tiling_factor + tile2, y);
    complex_expr first_B2_r1_prop_0 =  B1_prop(t, iCprime, iSprime, src_color_weights(0, wnumBlock, 0), src_spin_weights(0, wnumBlock, 0), x1 * tiling_factor + tile1, y);
    complex_expr second_B2_r1_prop_1 = B1_prop(t, jCprime, jSprime, src_color_weights(0, wnumBlock, 1), src_spin_weights(0, wnumBlock, 1), x1 * tiling_factor + tile1, y);
    complex_expr third_B2_r1_prop_2 =  B1_prop(t, kCprime, kSprime, src_color_weights(0, wnumBlock, 2), src_spin_weights(0, wnumBlock, 2), x1 * tiling_factor + tile1, y);
    ...
    computation B2_Blocal_r1_r_props_init("B2_Blocal_r1_r_props_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    computation B2_Blocal_r1_i_props_init("B2_Blocal_r1_i_props_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    computation B2_Bfirst_r1_r_props_init("B2_Bfirst_r1_r_props_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    computation B2_Bfirst_r1_i_props_init("B2_Bfirst_r1_i_props_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    computation B2_Bsecond_r1_r_props_init("B2_Bsecond_r1_r_props_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    computation B2_Bsecond_r1_i_props_init("B2_Bsecond_r1_i_props_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    computation B2_Bthird_r1_r_props_init("B2_Bthird_r1_r_props_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    computation B2_Bthird_r1_i_props_init("B2_Bthird_r1_i_props_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));

    computation B2_Blocal_r1_r_diquark("B2_Blocal_r1_r_diquark", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock}, B2_r1_diquark.get_real());
    computation B2_Blocal_r1_i_diquark("B2_Blocal_r1_i_diquark", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock}, B2_r1_diquark.get_imag());
    computation B2_Bfirst_r1_r_diquark("B2_Bfirst_r1_r_diquark", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock}, first_B2_r1_diquark.get_real());
    computation B2_Bfirst_r1_i_diquark("B2_Bfirst_r1_i_diquark", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock}, first_B2_r1_diquark.get_imag());
    computation B2_Bthird_r1_r_diquark("B2_Bthird_r1_r_diquark", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock}, third_B2_r1_diquark.get_real());
    computation B2_Bthird_r1_i_diquark("B2_Bthird_r1_i_diquark", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock}, third_B2_r1_diquark.get_imag());
    ...
    complex_expr B2_r1_props = B2_r1_prop_1 * B2_Blocal_r1_diquark(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock);
    complex_expr first_B2_r1_props = B2_r1_prop_1 * B2_Bfirst_r1_diquark(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock);
    complex_expr second_B2_r1_props = second_B2_r1_prop_1 * B2_Blocal_r1_diquark(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock);
    complex_expr third_B2_r1_props = B2_r1_prop_1 * B2_Bthird_r1_diquark(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock);

    computation B2_Blocal_r1_r_props("B2_Blocal_r1_r_props", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock, jCprime, jSprime}, B2_Blocal_r1_r_props_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime) + B2_r1_props.get_real());
    computation B2_Blocal_r1_i_props("B2_Blocal_r1_i_props", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock, jCprime, jSprime}, B2_Blocal_r1_i_props_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime) + B2_r1_props.get_imag());
    computation B2_Bfirst_r1_r_props("B2_Bfirst_r1_r_props", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock, jCprime, jSprime}, B2_Bfirst_r1_r_props_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime) + first_B2_r1_props.get_real());
    computation B2_Bfirst_r1_i_props("B2_Bfirst_r1_i_props", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock, jCprime, jSprime}, B2_Bfirst_r1_i_props_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime) + first_B2_r1_props.get_imag());
    computation B2_Bsecond_r1_r_props("B2_Bsecond_r1_r_props", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock, jCprime, jSprime}, B2_Bsecond_r1_r_props_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime) + second_B2_r1_props.get_real());
    computation B2_Bsecond_r1_i_props("B2_Bsecond_r1_i_props", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock, jCprime, jSprime}, B2_Bsecond_r1_i_props_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime) + second_B2_r1_props.get_imag());
    computation B2_Bthird_r1_r_props("B2_Bthird_r1_r_props", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock, jCprime, jSprime}, B2_Bthird_r1_r_props_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime) + third_B2_r1_props.get_real());
    computation B2_Bthird_r1_i_props("B2_Bthird_r1_i_props", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock, jCprime, jSprime}, B2_Bthird_r1_i_props_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime) + third_B2_r1_props.get_imag());
    ...
    complex_expr B2_r1 = src_psi_B2 * B2_Blocal_r1_props(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, Nw-1, jCprime, jSprime);
    complex_expr first_B2_r1 = src_psi_B2 * B2_Bfirst_r1_props(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, Nw-1, jCprime, jSprime);
    complex_expr second_B2_r1 = src_psi_B2 * B2_Bsecond_r1_props(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, Nw-1, jCprime, jSprime);
    complex_expr third_B2_r1 = src_psi_B2 * B2_Bthird_r1_props(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, Nw-1, jCprime, jSprime);

    computation B2_Blocal_r1_r_update("B2_Blocal_r1_r_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, B2_Blocal_r1_r_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + B2_r1.get_real());
    computation B2_Blocal_r1_i_update("B2_Blocal_r1_i_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, B2_Blocal_r1_i_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + B2_r1.get_imag());
    computation B2_Bfirst_r1_r_update("B2_Bfirst_r1_r_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, B2_Bfirst_r1_r_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + first_B2_r1.get_real());
    computation B2_Bfirst_r1_i_update("B2_Bfirst_r1_i_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, B2_Bfirst_r1_i_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + first_B2_r1.get_imag()); 
    computation B2_Bsecond_r1_r_update("B2_Bsecond_r1_r_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, B2_Bsecond_r1_r_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + second_B2_r1.get_real());
    computation B2_Bsecond_r1_i_update("B2_Bsecond_r1_i_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, B2_Bsecond_r1_i_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + second_B2_r1.get_imag());
    computation B2_Bthird_r1_r_update("B2_Bthird_r1_r_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, B2_Bthird_r1_r_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + third_B2_r1.get_real());
    computation B2_Bthird_r1_i_update("B2_Bthird_r1_i_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, B2_Bthird_r1_i_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + third_B2_r1.get_imag()); 

    complex_expr flip_B2_r1 = src_psi_B1 * B2_Blocal_r1_props(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, Nw-1, jCprime, jSprime);
    complex_expr flip_first_B2_r1 = src_psi_B1 * B2_Bfirst_r1_props(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, Nw-1, jCprime, jSprime);
    complex_expr flip_second_B2_r1 = src_psi_B1 * B2_Bsecond_r1_props(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, Nw-1, jCprime, jSprime);
    complex_expr flip_third_B2_r1 = src_psi_B1 * B2_Bthird_r1_props(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, Nw-1, jCprime, jSprime);

    computation flip_B2_Blocal_r1_r_update("flip_B2_Blocal_r1_r_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, flip_B2_Blocal_r1_r_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + flip_B2_r1.get_real());
    computation flip_B2_Blocal_r1_i_update("flip_B2_Blocal_r1_i_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, flip_B2_Blocal_r1_i_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + flip_B2_r1.get_imag());
    computation flip_B2_Bfirst_r1_r_update("flip_B2_Bfirst_r1_r_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, flip_B2_Bfirst_r1_r_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + flip_first_B2_r1.get_real());
    computation flip_B2_Bfirst_r1_i_update("flip_B2_Bfirst_r1_i_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, flip_B2_Bfirst_r1_i_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + flip_first_B2_r1.get_imag()); 
    computation flip_B2_Bsecond_r1_r_update("flip_B2_Bsecond_r1_r_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, flip_B2_Bsecond_r1_r_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + flip_second_B2_r1.get_real());
    computation flip_B2_Bsecond_r1_i_update("flip_B2_Bsecond_r1_i_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, flip_B2_Bsecond_r1_i_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + flip_second_B2_r1.get_imag());
    computation flip_B2_Bthird_r1_r_update("flip_B2_Bthird_r1_r_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, flip_B2_Bthird_r1_r_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + flip_third_B2_r1.get_real());
    computation flip_B2_Bthird_r1_i_update("flip_B2_Bthird_r1_i_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, flip_B2_Bthird_r1_i_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + flip_third_B2_r1.get_imag()); 

     // Computing B2_Blocal_r2, B2_Bsecond_r2, B2_Bfirst_r2

    computation B2_Blocal_r2_r_init("B2_Blocal_r2_r_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation B2_Blocal_r2_i_init("B2_Blocal_r2_i_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation B2_Bfirst_r2_r_init("B2_Bfirst_r2_r_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation B2_Bfirst_r2_i_init("B2_Bfirst_r2_i_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation B2_Bsecond_r2_r_init("B2_Bsecond_r2_r_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation B2_Bsecond_r2_i_init("B2_Bsecond_r2_i_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation B2_Bthird_r2_r_init("B2_Bthird_r2_r_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation B2_Bthird_r2_i_init("B2_Bthird_r2_i_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    ...
    computation flip_B2_Blocal_r2_r_init("flip_B2_Blocal_r2_r_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation flip_B2_Blocal_r2_i_init("flip_B2_Blocal_r2_i_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation flip_B2_Bfirst_r2_r_init("flip_B2_Bfirst_r2_r_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation flip_B2_Bfirst_r2_i_init("flip_B2_Bfirst_r2_i_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation flip_B2_Bsecond_r2_r_init("flip_B2_Bsecond_r2_r_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation flip_B2_Bsecond_r2_i_init("flip_B2_Bsecond_r2_i_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation flip_B2_Bthird_r2_r_init("flip_B2_Bthird_r2_r_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation flip_B2_Bthird_r2_i_init("flip_B2_Bthird_r2_i_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    ...
    complex_expr B2_r2_prop_0 =  B1_prop(t, iCprime, iSprime, src_color_weights(1, wnumBlock, 0), src_spin_weights(1, wnumBlock, 0), x2 * tiling_factor + tile2, y);
    complex_expr B2_r2_prop_2 =  B1_prop(t, kCprime, kSprime, src_color_weights(1, wnumBlock, 2), src_spin_weights(1, wnumBlock, 2), x2 * tiling_factor + tile2, y);
    complex_expr B2_r2_prop_1 = B1_prop(t, jCprime, jSprime, src_color_weights(1, wnumBlock, 1), src_spin_weights(1, wnumBlock, 1), x2 * tiling_factor + tile2, y);
    complex_expr first_B2_r2_prop_0 =  B1_prop(t, iCprime, iSprime, src_color_weights(1, wnumBlock, 0), src_spin_weights(1, wnumBlock, 0), x1 * tiling_factor + tile1, y);
    complex_expr second_B2_r2_prop_1 = B1_prop(t, jCprime, jSprime, src_color_weights(1, wnumBlock, 1), src_spin_weights(1, wnumBlock, 1), x1 * tiling_factor + tile1, y);
    complex_expr third_B2_r2_prop_2 =  B1_prop(t, kCprime, kSprime, src_color_weights(1, wnumBlock, 2), src_spin_weights(1, wnumBlock, 2), x1 * tiling_factor + tile1, y);
    ...
    computation B2_Blocal_r2_r_props_init("B2_Blocal_r2_r_props_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    computation B2_Blocal_r2_i_props_init("B2_Blocal_r2_i_props_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    computation B2_Bfirst_r2_r_props_init("B2_Bfirst_r2_r_props_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    computation B2_Bfirst_r2_i_props_init("B2_Bfirst_r2_i_props_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    computation B2_Bsecond_r2_r_props_init("B2_Bsecond_r2_r_props_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    computation B2_Bsecond_r2_i_props_init("B2_Bsecond_r2_i_props_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    computation B2_Bthird_r2_r_props_init("B2_Bthird_r2_r_props_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    computation B2_Bthird_r2_i_props_init("B2_Bthird_r2_i_props_init", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));

    computation B2_Blocal_r2_r_diquark("B2_Blocal_r2_r_diquark", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock}, B2_r2_diquark.get_real());
    computation B2_Blocal_r2_i_diquark("B2_Blocal_r2_i_diquark", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock}, B2_r2_diquark.get_imag());
    computation B2_Bfirst_r2_r_diquark("B2_Bfirst_r2_r_diquark", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock}, first_B2_r2_diquark.get_real());
    computation B2_Bfirst_r2_i_diquark("B2_Bfirst_r2_i_diquark", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock}, first_B2_r2_diquark.get_imag());
    computation B2_Bthird_r2_r_diquark("B2_Bthird_r2_r_diquark", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock}, third_B2_r2_diquark.get_real());
    computation B2_Bthird_r2_i_diquark("B2_Bthird_r2_i_diquark", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock}, third_B2_r2_diquark.get_imag());
    ...
    complex_expr B2_r2_props = B2_r2_prop_1 * B2_Blocal_r2_diquark(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock);
    complex_expr first_B2_r2_props = B2_r2_prop_1 * B2_Bfirst_r2_diquark(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock);
    complex_expr second_B2_r2_props = second_B2_r2_prop_1 * B2_Blocal_r2_diquark(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock);
    complex_expr third_B2_r2_props = B2_r2_prop_1 * B2_Bthird_r2_diquark(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock);

    computation B2_Blocal_r2_r_props("B2_Blocal_r2_r_props", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock, jCprime, jSprime}, B2_Blocal_r2_r_props_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime) + B2_r2_props.get_real());
    computation B2_Blocal_r2_i_props("B2_Blocal_r2_i_props", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock, jCprime, jSprime}, B2_Blocal_r2_i_props_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime) + B2_r2_props.get_imag());
    computation B2_Bfirst_r2_r_props("B2_Bfirst_r2_r_props", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock, jCprime, jSprime}, B2_Bfirst_r2_r_props_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime) + first_B2_r2_props.get_real());
    computation B2_Bfirst_r2_i_props("B2_Bfirst_r2_i_props", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock, jCprime, jSprime}, B2_Bfirst_r2_i_props_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime) + first_B2_r2_props.get_imag());
    computation B2_Bsecond_r2_r_props("B2_Bsecond_r2_r_props", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock, jCprime, jSprime}, B2_Bsecond_r2_r_props_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime) + second_B2_r2_props.get_real());
    computation B2_Bsecond_r2_i_props("B2_Bsecond_r2_i_props", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock, jCprime, jSprime}, B2_Bsecond_r2_i_props_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime) + second_B2_r2_props.get_imag());
    computation B2_Bthird_r2_r_props("B2_Bthird_r2_r_props", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock, jCprime, jSprime}, B2_Bthird_r2_r_props_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime) + third_B2_r2_props.get_real());
    computation B2_Bthird_r2_i_props("B2_Bthird_r2_i_props", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, wnumBlock, jCprime, jSprime}, B2_Bthird_r2_i_props_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime) + third_B2_r2_props.get_imag());
    ...
    complex_expr B2_r2 = src_psi_B2 * B2_Blocal_r2_props(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, Nw-1, jCprime, jSprime);
    complex_expr first_B2_r2 = src_psi_B2 * B2_Bfirst_r2_props(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, Nw-1, jCprime, jSprime);
    complex_expr second_B2_r2 = src_psi_B2 * B2_Bsecond_r2_props(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, Nw-1, jCprime, jSprime);
    complex_expr third_B2_r2 = src_psi_B2 * B2_Bthird_r2_props(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, Nw-1, jCprime, jSprime);

    computation B2_Blocal_r2_r_update("B2_Blocal_r2_r_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, B2_Blocal_r2_r_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + B2_r2.get_real());
    computation B2_Blocal_r2_i_update("B2_Blocal_r2_i_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, B2_Blocal_r2_i_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + B2_r2.get_imag());
    computation B2_Bfirst_r2_r_update("B2_Bfirst_r2_r_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, B2_Bfirst_r2_r_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + first_B2_r2.get_real());
    computation B2_Bfirst_r2_i_update("B2_Bfirst_r2_i_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, B2_Bfirst_r2_i_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + first_B2_r2.get_imag());
    computation B2_Bsecond_r2_r_update("B2_Bsecond_r2_r_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, B2_Bsecond_r2_r_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + second_B2_r2.get_real());
    computation B2_Bsecond_r2_i_update("B2_Bsecond_r2_i_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, B2_Bsecond_r2_i_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + second_B2_r2.get_imag());
    computation B2_Bthird_r2_r_update("B2_Bthird_r2_r_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, B2_Bthird_r2_r_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + third_B2_r2.get_real());
    computation B2_Bthird_r2_i_update("B2_Bthird_r2_i_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, B2_Bthird_r2_i_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + third_B2_r2.get_imag());

    complex_expr flip_B2_r2 = src_psi_B1 * B2_Blocal_r2_props(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, Nw-1, jCprime, jSprime);
    complex_expr flip_first_B2_r2 = src_psi_B1 * B2_Bfirst_r2_props(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, Nw-1, jCprime, jSprime);
    complex_expr flip_second_B2_r2 = src_psi_B1 * B2_Bsecond_r2_props(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, Nw-1, jCprime, jSprime);
    complex_expr flip_third_B2_r2 = src_psi_B1 * B2_Bthird_r2_props(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, Nw-1, jCprime, jSprime);

    computation flip_B2_Blocal_r2_r_update("flip_B2_Blocal_r2_r_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, flip_B2_Blocal_r2_r_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + flip_B2_r2.get_real());
    computation flip_B2_Blocal_r2_i_update("flip_B2_Blocal_r2_i_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, flip_B2_Blocal_r2_i_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + flip_B2_r2.get_imag());
    computation flip_B2_Bfirst_r2_r_update("flip_B2_Bfirst_r2_r_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, flip_B2_Bfirst_r2_r_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + flip_first_B2_r2.get_real());
    computation flip_B2_Bfirst_r2_i_update("flip_B2_Bfirst_r2_i_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, flip_B2_Bfirst_r2_i_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + flip_first_B2_r2.get_imag()); 
    computation flip_B2_Bsecond_r2_r_update("flip_B2_Bsecond_r2_r_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, flip_B2_Bsecond_r2_r_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + flip_second_B2_r2.get_real());
    computation flip_B2_Bsecond_r2_i_update("flip_B2_Bsecond_r2_i_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, flip_B2_Bsecond_r2_i_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + flip_second_B2_r2.get_imag());
    computation flip_B2_Bthird_r2_r_update("flip_B2_Bthird_r2_r_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, flip_B2_Bthird_r2_r_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + flip_third_B2_r2.get_real());
    computation flip_B2_Bthird_r2_i_update("flip_B2_Bthird_r2_i_update", {t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, y, jCprime, jSprime, m}, flip_B2_Bthird_r2_i_init(t, tile1, tile2, x1, iCprime, iSprime, x2, kCprime, kSprime, jCprime, jSprime, m) + flip_third_B2_r2.get_imag()); 
    
// BB_H

     // Computing src_B1_Blocal_r1

    computation src_B1_Blocal_r1_r_init("src_B1_Blocal_r1_r_init", {t, x_out, x_in, iCprime, iSprime, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation src_B1_Blocal_r1_i_init("src_B1_Blocal_r1_i_init", {t, x_out, x_in, iCprime, iSprime, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));

    complex_computation src_B1_Blocal_r1_init(&src_B1_Blocal_r1_r_init, &src_B1_Blocal_r1_i_init);

    computation flip_src_B1_Blocal_r1_r_init("flip_src_B1_Blocal_r1_r_init", {t, x_out, x_in, iCprime, iSprime, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation flip_src_B1_Blocal_r1_i_init("flip_src_B1_Blocal_r1_i_init", {t, x_out, x_in, iCprime, iSprime, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    ...
    computation src_B1_Blocal_r1_r_props_init("src_B1_Blocal_r1_r_props_init", {t, x_out, x_in, iCprime, iSprime, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    computation src_B1_Blocal_r1_i_props_init("src_B1_Blocal_r1_i_props_init", {t, x_out, x_in, iCprime, iSprime, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    ...
    computation src_B1_Blocal_r2_r_init("src_B1_Blocal_r2_r_init", {t, x_out, x_in, iCprime, iSprime, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation src_B1_Blocal_r2_i_init("src_B1_Blocal_r2_i_init", {t, x_out, x_in, iCprime, iSprime, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));

    complex_computation src_B1_Blocal_r2_init(&src_B1_Blocal_r2_r_init, &src_B1_Blocal_r2_i_init);

    computation flip_src_B1_Blocal_r2_r_init("flip_src_B1_Blocal_r2_r_init", {t, x_out, x_in, iCprime, iSprime, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation flip_src_B1_Blocal_r2_i_init("flip_src_B1_Blocal_r2_i_init", {t, x_out, x_in, iCprime, iSprime, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    ...
    complex_expr src_B1_r2_prop_0p = B1_prop(t, kCprime, kSprime, src_color_weights(1, wnumBlock, 0), src_spin_weights(1, wnumBlock, 0), x_out*sites_per_rank+x_in, y);
    complex_expr src_B1_r2_prop_2p = B1_prop(t, iCprime, iSprime, src_color_weights(1, wnumBlock, 2), src_spin_weights(1, wnumBlock, 2), x_out*sites_per_rank+x_in, y);
    ...
    computation src_B1_Blocal_r2_r_props_init("src_B1_Blocal_r2_r_props_init", {t, x_out, x_in, iCprime, iSprime, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    computation src_B1_Blocal_r2_i_props_init("src_B1_Blocal_r2_i_props_init", {t, x_out, x_in, iCprime, iSprime, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    ...
    computation src_B2_Blocal_r1_r_init("src_B2_Blocal_r1_r_init", {t, x_out, x_in, iCprime, iSprime, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation src_B2_Blocal_r1_i_init("src_B2_Blocal_r1_i_init", {t, x_out, x_in, iCprime, iSprime, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));

    complex_computation src_B2_Blocal_r1_init(&src_B2_Blocal_r1_r_init, &src_B2_Blocal_r1_i_init);

    computation flip_src_B2_Blocal_r1_r_init("flip_src_B2_Blocal_r1_r_init", {t, x_out, x_in, iCprime, iSprime, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation flip_src_B2_Blocal_r1_i_init("flip_src_B2_Blocal_r1_i_init", {t, x_out, x_in, iCprime, iSprime, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    ...
    computation src_B2_Blocal_r1_r_props_init("src_B2_Blocal_r1_r_props_init", {t, x_out, x_in, iCprime, iSprime, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    computation src_B2_Blocal_r1_i_props_init("src_B2_Blocal_r1_i_props_init", {t, x_out, x_in, iCprime, iSprime, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    ...
    computation src_B2_Blocal_r2_r_init("src_B2_Blocal_r2_r_init", {t, x_out, x_in, iCprime, iSprime, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation src_B2_Blocal_r2_i_init("src_B2_Blocal_r2_i_init", {t, x_out, x_in, iCprime, iSprime, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));

    complex_computation src_B2_Blocal_r2_init(&src_B2_Blocal_r2_r_init, &src_B2_Blocal_r2_i_init);

    computation flip_src_B2_Blocal_r2_r_init("flip_src_B2_Blocal_r2_r_init", {t, x_out, x_in, iCprime, iSprime, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    computation flip_src_B2_Blocal_r2_i_init("flip_src_B2_Blocal_r2_i_init", {t, x_out, x_in, iCprime, iSprime, kCprime, kSprime, jCprime, jSprime, m}, expr((float) 0));
    ...
    computation src_B2_Blocal_r2_r_props_init("src_B2_Blocal_r2_r_props_init", {t, x_out, x_in, iCprime, iSprime, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    computation src_B2_Blocal_r2_i_props_init("src_B2_Blocal_r2_i_props_init", {t, x_out, x_in, iCprime, iSprime, kCprime, kSprime, y, jCprime, jSprime}, expr((float) 0));
    ...
    computation snk_B1_Blocal_r1_r_init("snk_B1_Blocal_r1_r_init", {t, y_out, y_in, iCprime, iSprime, kCprime, kSprime, jCprime, jSprime, n}, expr((float) 0));
    computation snk_B1_Blocal_r1_i_init("snk_B1_Blocal_r1_i_init", {t, y_out, y_in, iCprime, iSprime, kCprime, kSprime, jCprime, jSprime, n}, expr((float) 0));

    complex_computation snk_B1_Blocal_r1_init(&snk_B1_Blocal_r1_r_init, &snk_B1_Blocal_r1_i_init);

    computation flip_snk_B1_Blocal_r1_r_init("flip_snk_B1_Blocal_r1_r_init", {t, y_out, y_in, iCprime, iSprime, kCprime, kSprime, jCprime, jSprime, n}, expr((float) 0));
    computation flip_snk_B1_Blocal_r1_i_init("flip_snk_B1_Blocal_r1_i_init", {t, y_out, y_in, iCprime, iSprime, kCprime, kSprime, jCprime, jSprime, n}, expr((float) 0));
    ...
    computation snk_B1_Blocal_r1_r_props_init("snk_B1_Blocal_r1_r_props_init", {t, y_out, y_in, iCprime, iSprime, kCprime, kSprime, x, jCprime, jSprime}, expr((float) 0));
    computation snk_B1_Blocal_r1_i_props_init("snk_B1_Blocal_r1_i_props_init", {t, y_out, y_in, iCprime, iSprime, kCprime, kSprime, x, jCprime, jSprime}, expr((float) 0));
    ...
    computation snk_B1_Blocal_r2_r_init("snk_B1_Blocal_r2_r_init", {t, y_out, y_in, iCprime, iSprime, kCprime, kSprime, jCprime, jSprime, n}, expr((float) 0));
    computation snk_B1_Blocal_r2_i_init("snk_B1_Blocal_r2_i_init", {t, y_out, y_in, iCprime, iSprime, kCprime, kSprime, jCprime, jSprime, n}, expr((float) 0));

    complex_computation snk_B1_Blocal_r2_init(&snk_B1_Blocal_r2_r_init, &snk_B1_Blocal_r2_i_init);

    computation flip_snk_B1_Blocal_r2_r_init("flip_snk_B1_Blocal_r2_r_init", {t, y_out, y_in, iCprime, iSprime, kCprime, kSprime, jCprime, jSprime, n}, expr((float) 0));
    computation flip_snk_B1_Blocal_r2_i_init("flip_snk_B1_Blocal_r2_i_init", {t, y_out, y_in, iCprime, iSprime, kCprime, kSprime, jCprime, jSprime, n}, expr((float) 0));
    ...
    computation snk_B1_Blocal_r2_r_props_init("snk_B1_Blocal_r2_r_props_init", {t, y_out, y_in, iCprime, iSprime, kCprime, kSprime, x, jCprime, jSprime}, expr((float) 0));
    computation snk_B1_Blocal_r2_i_props_init("snk_B1_Blocal_r2_i_props_init", {t, y_out, y_in, iCprime, iSprime, kCprime, kSprime, x, jCprime, jSprime}, expr((float) 0));
    ...
    computation snk_B2_Blocal_r1_r_init("snk_B2_Blocal_r1_r_init", {t, y_out, y_in, iCprime, iSprime, kCprime, kSprime, jCprime, jSprime, n}, expr((float) 0));
    computation snk_B2_Blocal_r1_i_init("snk_B2_Blocal_r1_i_init", {t, y_out, y_in, iCprime, iSprime, kCprime, kSprime, jCprime, jSprime, n}, expr((float) 0));

    complex_computation snk_B2_Blocal_r1_init(&snk_B2_Blocal_r1_r_init, &snk_B2_Blocal_r1_i_init);

    computation flip_snk_B2_Blocal_r1_r_init("flip_snk_B2_Blocal_r1_r_init", {t, y_out, y_in, iCprime, iSprime, kCprime, kSprime, jCprime, jSprime, n}, expr((float) 0));
    computation flip_snk_B2_Blocal_r1_i_init("flip_snk_B2_Blocal_r1_i_init", {t, y_out, y_in, iCprime, iSprime, kCprime, kSprime, jCprime, jSprime, n}, expr((float) 0));
    ...
    computation snk_B2_Blocal_r1_r_props_init("snk_B2_Blocal_r1_r_props_init", {t, y_out, y_in, iCprime, iSprime, kCprime, kSprime, x, jCprime, jSprime}, expr((float) 0));
    computation snk_B2_Blocal_r1_i_props_init("snk_B2_Blocal_r1_i_props_init", {t, y_out, y_in, iCprime, iSprime, kCprime, kSprime, x, jCprime, jSprime}, expr((float) 0));
    ...
    computation snk_B2_Blocal_r2_r_init("snk_B2_Blocal_r2_r_init", {t, y_out, y_in, iCprime, iSprime, kCprime, kSprime, jCprime, jSprime, n}, expr((float) 0));
    computation snk_B2_Blocal_r2_i_init("snk_B2_Blocal_r2_i_init", {t, y_out, y_in, iCprime, iSprime, kCprime, kSprime, jCprime, jSprime, n}, expr((float) 0));

    complex_computation snk_B2_Blocal_r2_init(&snk_B2_Blocal_r2_r_init, &snk_B2_Blocal_r2_i_init);

    computation flip_snk_B2_Blocal_r2_r_init("flip_snk_B2_Blocal_r2_r_init", {t, y_out, y_in, iCprime, iSprime, kCprime, kSprime, jCprime, jSprime, n}, expr((float) 0));
    computation flip_snk_B2_Blocal_r2_i_init("flip_snk_B2_Blocal_r2_i_init", {t, y_out, y_in, iCprime, iSprime, kCprime, kSprime, jCprime, jSprime, n}, expr((float) 0));
    ...
    computation snk_B2_Blocal_r2_r_props_init("snk_B2_Blocal_r2_r_props_init", {t, y_out, y_in, iCprime, iSprime, kCprime, kSprime, x, jCprime, jSprime}, expr((float) 0));
    computation snk_B2_Blocal_r2_i_props_init("snk_B2_Blocal_r2_i_props_init", {t, y_out, y_in, iCprime, iSprime, kCprime, kSprime, x, jCprime, jSprime}, expr((float) 0));
    ...
    computation C_init_r("C_init_r", {t, x_out, x_in, rp, mpmH, r, npnH}, expr((float) 0));
    computation C_init_i("C_init_i", {t, x_out, x_in, rp, mpmH, r, npnH}, expr((float) 0));

    // BB_BB
    computation C_BB_BB_prop_init_r("C_BB_BB_prop_init_r", {t, tile1, tile2, x1, rp, x2, r, m}, expr((float) 0));
    computation C_BB_BB_prop_init_i("C_BB_BB_prop_init_i", {t, tile1, tile2, x1, rp, x2, r, m}, expr((float) 0));
    
    b=0;
    // r1, b = 0 
    complex_computation BB_BB_new_term_0_r1_b1("BB_BB_new_term_0_r1_b1", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B1_Blocal_r1_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation BB_BB_new_term_1_r1_b1("BB_BB_new_term_1_r1_b1", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B2_Blocal_r1_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation BB_BB_new_term_2_r1_b1("BB_BB_new_term_2_r1_b1", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B1_Bfirst_r1_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation BB_BB_new_term_3_r1_b1("BB_BB_new_term_3_r1_b1", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B2_Bfirst_r1_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation BB_BB_new_term_4_r1_b1("BB_BB_new_term_4_r1_b1", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B1_Bsecond_r1_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation BB_BB_new_term_5_r1_b1("BB_BB_new_term_5_r1_b1", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B2_Bsecond_r1_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation BB_BB_new_term_6_r1_b1("BB_BB_new_term_6_r1_b1", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B1_Bthird_r1_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation BB_BB_new_term_7_r1_b1("BB_BB_new_term_7_r1_b1", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B2_Bthird_r1_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    ...
    // r2, b = 0 
    complex_computation BB_BB_new_term_0_r2_b1("BB_BB_new_term_0_r2_b1", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B1_Blocal_r2_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation BB_BB_new_term_1_r2_b1("BB_BB_new_term_1_r2_b1", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B2_Blocal_r2_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation BB_BB_new_term_2_r2_b1("BB_BB_new_term_2_r2_b1", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B1_Bfirst_r2_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation BB_BB_new_term_3_r2_b1("BB_BB_new_term_3_r2_b1", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B2_Bfirst_r2_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation BB_BB_new_term_4_r2_b1("BB_BB_new_term_4_r2_b1", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B1_Bsecond_r2_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation BB_BB_new_term_5_r2_b1("BB_BB_new_term_5_r2_b1", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B2_Bsecond_r2_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation BB_BB_new_term_6_r2_b1("BB_BB_new_term_6_r2_b1", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B1_Bthird_r2_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation BB_BB_new_term_7_r2_b1("BB_BB_new_term_7_r2_b1", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B2_Bthird_r2_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    ...
    b=1;
    // r1, b = 1 
    complex_computation BB_BB_new_term_0_r1_b2("BB_BB_new_term_0_r1_b2", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B1_Blocal_r1_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation BB_BB_new_term_1_r1_b2("BB_BB_new_term_1_r1_b2", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B2_Blocal_r1_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation BB_BB_new_term_2_r1_b2("BB_BB_new_term_2_r1_b2", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B1_Bfirst_r1_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation BB_BB_new_term_3_r1_b2("BB_BB_new_term_3_r1_b2", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B2_Bfirst_r1_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation BB_BB_new_term_4_r1_b2("BB_BB_new_term_4_r1_b2", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B1_Bsecond_r1_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation BB_BB_new_term_5_r1_b2("BB_BB_new_term_5_r1_b2", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B2_Bsecond_r1_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation BB_BB_new_term_6_r1_b2("BB_BB_new_term_6_r1_b2", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B1_Bthird_r1_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation BB_BB_new_term_7_r1_b2("BB_BB_new_term_7_r1_b2", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B2_Bthird_r1_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    ...
    // r2, b = 1
    complex_computation BB_BB_new_term_1_r2_b2("BB_BB_new_term_1_r2_b2", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B2_Blocal_r2_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation BB_BB_new_term_0_r2_b2("BB_BB_new_term_0_r2_b2", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B1_Blocal_r2_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation BB_BB_new_term_2_r2_b2("BB_BB_new_term_2_r2_b2", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B1_Bfirst_r2_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation BB_BB_new_term_3_r2_b2("BB_BB_new_term_3_r2_b2", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B2_Bfirst_r2_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation BB_BB_new_term_4_r2_b2("BB_BB_new_term_4_r2_b2", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B1_Bsecond_r2_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation BB_BB_new_term_5_r2_b2("BB_BB_new_term_5_r2_b2", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B2_Bsecond_r2_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation BB_BB_new_term_6_r2_b2("BB_BB_new_term_6_r2_b2", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B1_Bthird_r2_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation BB_BB_new_term_7_r2_b2("BB_BB_new_term_7_r2_b2", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, B2_Bthird_r2_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    ...
    complex_expr prefactor(cast(p_float32, sigs(nperm)) * snk_weights(r, wnum) * src_spin_block_weights(rp, s), cast(p_float32,0.0));

    complex_expr BB_BB_term_res_b1 = BB_BB_new_term_0_r1_b1(t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum);
    complex_expr BB_BB_term_res_b2 = BB_BB_new_term_0_r1_b2(t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum);

    complex_expr BB_BB_term_res = prefactor * BB_BB_term_res_b1 * BB_BB_term_res_b2;

    b=0;
    // r1, b = 0 
    complex_computation flip_BB_BB_new_term_0_r1_b1("flip_BB_BB_new_term_0_r1_b1", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B1_Blocal_r1_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation flip_BB_BB_new_term_1_r1_b1("flip_BB_BB_new_term_1_r1_b1", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B2_Blocal_r1_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation flip_BB_BB_new_term_2_r1_b1("flip_BB_BB_new_term_2_r1_b1", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B1_Bfirst_r1_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation flip_BB_BB_new_term_3_r1_b1("flip_BB_BB_new_term_3_r1_b1", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B2_Bfirst_r1_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation flip_BB_BB_new_term_4_r1_b1("flip_BB_BB_new_term_4_r1_b1", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B1_Bsecond_r1_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation flip_BB_BB_new_term_5_r1_b1("flip_BB_BB_new_term_5_r1_b1", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B2_Bsecond_r1_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation flip_BB_BB_new_term_6_r1_b1("flip_BB_BB_new_term_6_r1_b1", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B1_Bthird_r1_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation flip_BB_BB_new_term_7_r1_b1("flip_BB_BB_new_term_7_r1_b1", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B2_Bthird_r1_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    ...
    // r2, b = 0 
    complex_computation flip_BB_BB_new_term_0_r2_b1("flip_BB_BB_new_term_0_r2_b1", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B1_Blocal_r2_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation flip_BB_BB_new_term_1_r2_b1("flip_BB_BB_new_term_1_r2_b1", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B2_Blocal_r2_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation flip_BB_BB_new_term_2_r2_b1("flip_BB_BB_new_term_2_r2_b1", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B1_Bfirst_r2_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation flip_BB_BB_new_term_3_r2_b1("flip_BB_BB_new_term_3_r2_b1", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B2_Bfirst_r2_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation flip_BB_BB_new_term_4_r2_b1("flip_BB_BB_new_term_4_r2_b1", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B1_Bsecond_r2_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation flip_BB_BB_new_term_5_r2_b1("flip_BB_BB_new_term_5_r2_b1", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B2_Bsecond_r2_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation flip_BB_BB_new_term_6_r2_b1("flip_BB_BB_new_term_6_r2_b1", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B1_Bthird_r2_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    complex_computation flip_BB_BB_new_term_7_r2_b1("flip_BB_BB_new_term_7_r2_b1", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B2_Bthird_r2_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 0), snk_spin_weights(r, nperm, wnum, 0, 0), x2, snk_color_weights(r, nperm, wnum, 2, 0), snk_spin_weights(r, nperm, wnum, 2, 0), snk_color_weights(r, nperm, wnum, 1, 0), snk_spin_weights(r, nperm, wnum, 1, 0), m));
    ...
    b=1;
    // r1, b = 1 
    complex_computation flip_BB_BB_new_term_0_r1_b2("flip_BB_BB_new_term_0_r1_b2", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B1_Blocal_r1_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation flip_BB_BB_new_term_1_r1_b2("flip_BB_BB_new_term_1_r1_b2", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B2_Blocal_r1_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation flip_BB_BB_new_term_2_r1_b2("flip_BB_BB_new_term_2_r1_b2", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B1_Bfirst_r1_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation flip_BB_BB_new_term_3_r1_b2("flip_BB_BB_new_term_3_r1_b2", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B2_Bfirst_r1_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation flip_BB_BB_new_term_4_r1_b2("flip_BB_BB_new_term_4_r1_b2", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B1_Bsecond_r1_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation flip_BB_BB_new_term_5_r1_b2("flip_BB_BB_new_term_5_r1_b2", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B2_Bsecond_r1_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation flip_BB_BB_new_term_6_r1_b2("flip_BB_BB_new_term_6_r1_b2", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B1_Bthird_r1_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation flip_BB_BB_new_term_7_r1_b2("flip_BB_BB_new_term_7_r1_b2", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B2_Bthird_r1_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    ...
    // r2, b = 1 
    complex_computation flip_BB_BB_new_term_0_r2_b2("flip_BB_BB_new_term_0_r2_b2", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B1_Blocal_r2_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation flip_BB_BB_new_term_1_r2_b2("flip_BB_BB_new_term_1_r2_b2", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B2_Blocal_r2_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation flip_BB_BB_new_term_2_r2_b2("flip_BB_BB_new_term_2_r2_b2", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B1_Bfirst_r2_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation flip_BB_BB_new_term_3_r2_b2("flip_BB_BB_new_term_3_r2_b2", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B2_Bfirst_r2_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation flip_BB_BB_new_term_4_r2_b2("flip_BB_BB_new_term_4_r2_b2", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B1_Bsecond_r2_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation flip_BB_BB_new_term_5_r2_b2("flip_BB_BB_new_term_5_r2_b2", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B2_Bsecond_r2_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation flip_BB_BB_new_term_6_r2_b2("flip_BB_BB_new_term_6_r2_b2", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B1_Bthird_r2_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    complex_computation flip_BB_BB_new_term_7_r2_b2("flip_BB_BB_new_term_7_r2_b2", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, flip_B2_Bthird_r2_init(t, tile1, tile2, x1, snk_color_weights(r, nperm, wnum, 0, 1), snk_spin_weights(r, nperm, wnum, 0, 1), x2, snk_color_weights(r, nperm, wnum, 2, 1), snk_spin_weights(r, nperm, wnum, 2, 1), snk_color_weights(r, nperm, wnum, 1, 1), snk_spin_weights(r, nperm, wnum, 1, 1), m));
    ...
    complex_expr flip_BB_BB_term_res_b1 = flip_BB_BB_new_term_0_r1_b1(t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum);
    complex_expr flip_BB_BB_term_res_b2 = flip_BB_BB_new_term_0_r1_b2(t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum);

    complex_expr flip_BB_BB_term_res = prefactor * flip_BB_BB_term_res_b1 * flip_BB_BB_term_res_b2;

    computation C_BB_BB_prop_update_r("C_BB_BB_prop_update_r", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, C_BB_BB_prop_init_r(t, tile1, tile2, x1, rp, x2, r, m) + tiramisu::expr((float) 0.5 ) * BB_BB_term_res.get_real() );
    computation C_BB_BB_prop_update_i("C_BB_BB_prop_update_i", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, C_BB_BB_prop_init_i(t, tile1, tile2, x1, rp, x2, r, m) + tiramisu::expr((float) 0.5 ) * BB_BB_term_res.get_imag() );

    computation C_BB_BB_prop_update_r_2("C_BB_BB_prop_update_r_2", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, C_BB_BB_prop_init_r(t, tile1, tile2, x1, rp, x2, r, m) + tiramisu::expr((float) 0.5 ) * flip_BB_BB_term_res.get_real() );
    computation C_BB_BB_prop_update_i_2("C_BB_BB_prop_update_i_2", {t, tile1, tile2, x1, rp, x2, r, m, s, nperm, wnum}, C_BB_BB_prop_init_i(t, tile1, tile2, x1, rp, x2, r, m) + tiramisu::expr((float) 0.5 ) * flip_BB_BB_term_res.get_imag() );

    complex_computation C_BB_BB_prop_update(&C_BB_BB_prop_update_r, &C_BB_BB_prop_update_i);

    complex_expr BB_BB_term_s = (snk_psi_B1_ue * snk_psi_B2_x2_ue + snk_psi_B1_x2_ue * snk_psi_B2_ue) * C_BB_BB_prop_update(t, tile1, tile2, x1, rp, x2, r, m, 1, Nperms-1, Nw2-1);
    complex_expr BB_BB_term_b = snk_psi * C_BB_BB_prop_update(t, tile1, tile2, x1, rp, x2, r, m, 1, Nperms-1, Nw2-1);

    computation C_BB_init_r("C_BB_init_r", {t, tile1, tile2, x1, rp, x2, r, m, n}, expr((float) 0));
    computation C_BB_init_i("C_BB_init_i", {t, tile1, tile2, x1, rp, x2, r, m, n}, expr((float) 0));
    computation buf_C_BB_r_cpu_init("buf_C_BB_r_cpu_init", {t, tile1, tile2, x1, rp, x2, r, m, n}, expr((float) 0));
    computation buf_C_BB_i_cpu_init("buf_C_BB_i_cpu_init", {t, tile1, tile2, x1, rp, x2, r, m, n}, expr((float) 0));
    computation out_buf_C_BB_r_cpu_init("out_buf_C_BB_r_cpu_init", {t, rp, r, m, n}, expr((float) 0));
    computation out_buf_C_BB_i_cpu_init("out_buf_C_BB_i_cpu_init", {t, rp, r, m, n}, expr((float) 0));

    buffer buf_C_BB_r("buf_C_BB_r", { Vsnk / tiling_factor, Vsnk / tiling_factor, B2Nrows, Nsrc, B2Nrows, Nsnk}, p_float32, a_temporary);
    buffer buf_C_BB_i("buf_C_BB_i", { Vsnk / tiling_factor, Vsnk / tiling_factor, B2Nrows, Nsrc, B2Nrows, Nsnk}, p_float32, a_temporary);
    buffer buf_C_BB_r_cpu("buf_C_BB_r_cpu", { Vsnk / tiling_factor, Vsnk / tiling_factor, B2Nrows, Nsrc, B2Nrows, Nsnk}, p_float32, a_temporary);
    buffer buf_C_BB_i_cpu("buf_C_BB_i_cpu", { Vsnk / tiling_factor, Vsnk / tiling_factor, B2Nrows, Nsrc, B2Nrows, Nsnk}, p_float32, a_temporary);
    buffer out_buf_C_BB_r_cpu("out_buf_C_BB_r_cpu", { Lt, B2Nrows, Nsrc, B2Nrows, Nsnk}, p_float32, a_temporary);
    buffer out_buf_C_BB_i_cpu("out_buf_C_BB_i_cpu", { Lt, B2Nrows, Nsrc, B2Nrows, Nsnk}, p_float32, a_temporary);
    ...
    computation reduce_buf_C_BB_r_cpu("reduce_buf_C_BB_r_cpu", {t, tile1, tile2, x1, rp, x2, r, m, n}, p_float32);
    ...
    computation reduce_buf_C_BB_i_cpu("reduce_buf_C_BB_i_cpu", {t, tile1, tile2, x1, rp, x2, r, m, n}, p_float32);
    reduce_buf_C_BB_i_cpu.set_expression( reduce_buf_C_BB_i_cpu( t, tile1, tile2, x1, rp, x2, r, m, n) + buf_C_BB_i_cpu_init( t, tile1, tile2, x1, rp, x2, r, m, n ) );
    ...
    computation C_BB_BB_update_b_r("C_BB_BB_update_b_r", {t, tile1, tile2, x1, rp, x2, r, m, ne}, C_BB_init_r(t, tile1, tile2, x1, rp, x2, r, m, ne) + BB_BB_term_b.get_real());
    computation C_BB_BB_update_b_i("C_BB_BB_update_b_i", {t, tile1, tile2, x1, rp, x2, r, m, ne}, C_BB_init_i(t, tile1, tile2, x1, rp, x2, r, m, ne) + BB_BB_term_b.get_imag());

    // BB_H
    computation C_BB_H_prop_init_r("C_BB_H_prop_init_r", {t, x_out, x_in, rp, m, r}, expr((float) 0));
    computation C_BB_H_prop_init_i("C_BB_H_prop_init_i", {t, x_out, x_in, rp, m, r}, expr((float) 0));
    ...
    complex_expr src_hex_prefactor(cast(p_float32, sigs(nperm)) * hex_snk_weights(r, wnumHex) * src_spin_block_weights(rp, s), cast(p_float32,0.0));
    ...
    computation C_BB_H_prop_update_r("C_BB_H_prop_update_r", {t, x_out, x_in, rp, m, r, s, nperm, wnumHex}, C_BB_H_prop_init_r(t, x_out, x_in, rp, m, r) + (BB_H_term_res.get_real() + flip_BB_H_term_res.get_real())/cast(p_float32,2.0) );
    computation C_BB_H_prop_update_i("C_BB_H_prop_update_i", {t, x_out, x_in, rp, m, r, s, nperm, wnumHex}, C_BB_H_prop_init_i(t, x_out, x_in, rp, m, r) + (BB_H_term_res.get_imag() + flip_BB_H_term_res.get_imag())/cast(p_float32,2.0) );
    ...
    // H_BB
    computation C_H_BB_prop_init_r("C_H_BB_prop_init_r", {t, y_out, y_in, rp, n, r}, expr((float) 0));
    computation C_H_BB_prop_init_i("C_H_BB_prop_init_i", {t, y_out, y_in, rp, n, r}, expr((float) 0));
    ...
    complex_expr snk_hex_prefactor(cast(p_float32, sigs(nperm)) * hex_snk_weights(r, wnumHex) * src_spin_block_weights(rp, s), cast(p_float32,0.0));
    ...
    computation C_H_BB_prop_update_r("C_H_BB_prop_update_r", {t, y_out, y_in, rp, n, r, s, nperm, wnumHex}, C_H_BB_prop_init_r(t, y_out, y_in, rp, n, r) + ((*H_BB_term_res_comp.get_real())(t, y_out, y_in, rp, n, r, s, nperm, wnumHex) + flip_H_BB_term_res.get_real())/cast(p_float32,2.0) );
    computation C_H_BB_prop_update_i("C_H_BB_prop_update_i", {t, y_out, y_in, rp, n, r, s, nperm, wnumHex}, C_H_BB_prop_init_i(t, y_out, y_in, rp, n, r) + ((*H_BB_term_res_comp.get_imag())(t, y_out, y_in, rp, n, r, s, nperm, wnumHex) + flip_H_BB_term_res.get_imag())/cast(p_float32,2.0) );
    ...
    // H_H
    computation C_H_H_prop_init_r("C_H_H_prop_init_r", {t, x_out, x_in, rp, r, y}, expr((float) 0));
    computation C_H_H_prop_init_i("C_H_H_prop_init_i", {t, x_out, x_in, rp, r, y}, expr((float) 0));
    ...
    complex_expr hex_hex_prefactor(cast(p_float32, sigs(nperm)) * hex_snk_weights(r, wnumHex) * hex_snk_weights(rp, wnumHexHex), cast(p_float32,0.0));
    ...
    buffer buf_B1_Blocal_r1_r("buf_B1_Blocal_r1_r",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_B1_Blocal_r1_i("buf_B1_Blocal_r1_i",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_B1_Bfirst_r1_r("buf_B1_Bfirst_r1_r",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_B1_Bfirst_r1_i("buf_B1_Bfirst_r1_i",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_B1_Bsecond_r1_r("buf_B1_Bsecond_r1_r",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_B1_Bsecond_r1_i("buf_B1_Bsecond_r1_i",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_B1_Bthird_r1_r("buf_B1_Bthird_r1_r",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_B1_Bthird_r1_i("buf_B1_Bthird_r1_i",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    ...
    buffer buf_flip_B1_Blocal_r1_r("buf_flip_B1_Blocal_r1_r",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_flip_B1_Blocal_r1_i("buf_flip_B1_Blocal_r1_i",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_flip_B1_Bfirst_r1_r("buf_flip_B1_Bfirst_r1_r",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_flip_B1_Bfirst_r1_i("buf_flip_B1_Bfirst_r1_i",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_flip_B1_Bsecond_r1_r("buf_flip_B1_Bsecond_r1_r",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_flip_B1_Bsecond_r1_i("buf_flip_B1_Bsecond_r1_i",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_flip_B1_Bthird_r1_r("buf_flip_B1_Bthird_r1_r",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_flip_B1_Bthird_r1_i("buf_flip_B1_Bthird_r1_i",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    ...
    buffer buf_B1_Blocal_diquark_r1_r("buf_B1_Blocal_diquark_r1_r",   {Vsnk / tiling_factor, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B1_Blocal_diquark_r1_i("buf_B1_Blocal_diquark_r1_i",   {Vsnk / tiling_factor, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B1_Bfirst_diquark_r1_r("buf_B1_Bfirst_diquark_r1_r",   {Vsnk / tiling_factor, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B1_Bfirst_diquark_r1_i("buf_B1_Bfirst_diquark_r1_i",   {Vsnk / tiling_factor, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B1_Bthird_diquark_r1_r("buf_B1_Bthird_diquark_r1_r",   {Vsnk / tiling_factor, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B1_Bthird_diquark_r1_i("buf_B1_Bthird_diquark_r1_i",   {Vsnk / tiling_factor, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    ...
    buffer buf_B1_Blocal_props_r1_r("buf_B1_Blocal_props_r1_r",   {Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B1_Blocal_props_r1_i("buf_B1_Blocal_props_r1_i",   {Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B1_Bfirst_props_r1_r("buf_B1_Bfirst_props_r1_r",   {Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B1_Bfirst_props_r1_i("buf_B1_Bfirst_props_r1_i",   {Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B1_Bsecond_props_r1_r("buf_B1_Bsecond_props_r1_r",   {Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B1_Bsecond_props_r1_i("buf_B1_Bsecond_props_r1_i",   {Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B1_Bthird_props_r1_r("buf_B1_Bthird_props_r1_r",   {Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B1_Bthird_props_r1_i("buf_B1_Bthird_props_r1_i",   {Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    ...
    buffer buf_B1_Blocal_r2_r("buf_B1_Blocal_r2_r",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_B1_Blocal_r2_i("buf_B1_Blocal_r2_i",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_B1_Bfirst_r2_r("buf_B1_Bfirst_r2_r",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_B1_Bfirst_r2_i("buf_B1_Bfirst_r2_i",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_B1_Bsecond_r2_r("buf_B1_Bsecond_r2_r",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_B1_Bsecond_r2_i("buf_B1_Bsecond_r2_i",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_B1_Bthird_r2_r("buf_B1_Bthird_r2_r",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_B1_Bthird_r2_i("buf_B1_Bthird_r2_i",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    ...
    buffer buf_flip_B1_Blocal_r2_r("buf_flip_B1_Blocal_r2_r",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_flip_B1_Blocal_r2_i("buf_flip_B1_Blocal_r2_i",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_flip_B1_Bfirst_r2_r("buf_flip_B1_Bfirst_r2_r",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_flip_B1_Bfirst_r2_i("buf_flip_B1_Bfirst_r2_i",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_flip_B1_Bsecond_r2_r("buf_flip_B1_Bsecond_r2_r",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_flip_B1_Bsecond_r2_i("buf_flip_B1_Bsecond_r2_i",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_flip_B1_Bthird_r2_r("buf_flip_B1_Bthird_r2_r",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_flip_B1_Bthird_r2_i("buf_flip_B1_Bthird_r2_i",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    ...
    buffer buf_B1_Blocal_diquark_r2_r("buf_B1_Blocal_diquark_r2_r",   {Vsnk / tiling_factor, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B1_Blocal_diquark_r2_i("buf_B1_Blocal_diquark_r2_i",   {Vsnk / tiling_factor, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B1_Bfirst_diquark_r2_r("buf_B1_Bfirst_diquark_r2_r",   {Vsnk / tiling_factor, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B1_Bfirst_diquark_r2_i("buf_B1_Bfirst_diquark_r2_i",   {Vsnk / tiling_factor, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B1_Bthird_diquark_r2_r("buf_B1_Bthird_diquark_r2_r",   {Vsnk / tiling_factor, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B1_Bthird_diquark_r2_i("buf_B1_Bthird_diquark_r2_i",   {Vsnk / tiling_factor, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    ...
    buffer buf_B1_Blocal_props_r2_r("buf_B1_Blocal_props_r2_r",   {Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B1_Blocal_props_r2_i("buf_B1_Blocal_props_r2_i",   {Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B1_Bfirst_props_r2_r("buf_B1_Bfirst_props_r2_r",   {Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B1_Bfirst_props_r2_i("buf_B1_Bfirst_props_r2_i",   {Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B1_Bsecond_props_r2_r("buf_B1_Bsecond_props_r2_r",   {Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B1_Bsecond_props_r2_i("buf_B1_Bsecond_props_r2_i",   {Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B1_Bthird_props_r2_r("buf_B1_Bthird_props_r2_r",   {Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B1_Bthird_props_r2_i("buf_B1_Bthird_props_r2_i",   {Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    ...
    buffer buf_B2_Blocal_r1_r("buf_B2_Blocal_r1_r",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_B2_Blocal_r1_i("buf_B2_Blocal_r1_i",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_B2_Bfirst_r1_r("buf_B2_Bfirst_r1_r",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_B2_Bfirst_r1_i("buf_B2_Bfirst_r1_i",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_B2_Bsecond_r1_r("buf_B2_Bsecond_r1_r",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_B2_Bsecond_r1_i("buf_B2_Bsecond_r1_i",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_B2_Bthird_r1_r("buf_B2_Bthird_r1_r",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_B2_Bthird_r1_i("buf_B2_Bthird_r1_i",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    ...
    buffer buf_flip_B2_Blocal_r1_r("buf_flip_B2_Blocal_r1_r",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_flip_B2_Blocal_r1_i("buf_flip_B2_Blocal_r1_i",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_flip_B2_Bfirst_r1_r("buf_flip_B2_Bfirst_r1_r",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_flip_B2_Bfirst_r1_i("buf_flip_B2_Bfirst_r1_i",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_flip_B2_Bsecond_r1_r("buf_flip_B2_Bsecond_r1_r",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_flip_B2_Bsecond_r1_i("buf_flip_B2_Bsecond_r1_i",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_flip_B2_Bthird_r1_r("buf_flip_B2_Bthird_r1_r",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_flip_B2_Bthird_r1_i("buf_flip_B2_Bthird_r1_i",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    ...
    buffer buf_B2_Blocal_diquark_r1_r("buf_B2_Blocal_diquark_r1_r",   {Vsnk / tiling_factor, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B2_Blocal_diquark_r1_i("buf_B2_Blocal_diquark_r1_i",   {Vsnk / tiling_factor, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B2_Bfirst_diquark_r1_r("buf_B2_Bfirst_diquark_r1_r",   {Vsnk / tiling_factor, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B2_Bfirst_diquark_r1_i("buf_B2_Bfirst_diquark_r1_i",   {Vsnk / tiling_factor, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B2_Bthird_diquark_r1_r("buf_B2_Bthird_diquark_r1_r",   {Vsnk / tiling_factor, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B2_Bthird_diquark_r1_i("buf_B2_Bthird_diquark_r1_i",   {Vsnk / tiling_factor, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    ...
    buffer buf_B2_Blocal_props_r1_r("buf_B2_Blocal_props_r1_r",   {Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B2_Blocal_props_r1_i("buf_B2_Blocal_props_r1_i",   {Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B2_Bfirst_props_r1_r("buf_B2_Bfirst_props_r1_r",   {Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B2_Bfirst_props_r1_i("buf_B2_Bfirst_props_r1_i",   {Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B2_Bsecond_props_r1_r("buf_B2_Bsecond_props_r1_r",   {Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B2_Bsecond_props_r1_i("buf_B2_Bsecond_props_r1_i",   {Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B2_Bthird_props_r1_r("buf_B2_Bthird_props_r1_r",   {Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B2_Bthird_props_r1_i("buf_B2_Bthird_props_r1_i",   {Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    ...
    buffer buf_B2_Blocal_r2_r("buf_B2_Blocal_r2_r",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B2_Blocal_r2_i("buf_B2_Blocal_r2_i",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B2_Bfirst_r2_r("buf_B2_Bfirst_r2_r",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B2_Bfirst_r2_i("buf_B2_Bfirst_r2_i",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B2_Bsecond_r2_r("buf_B2_Bsecond_r2_r",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B2_Bsecond_r2_i("buf_B2_Bsecond_r2_i",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B2_Bthird_r2_r("buf_B2_Bthird_r2_r",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B2_Bthird_r2_i("buf_B2_Bthird_r2_i",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    ...
    buffer buf_flip_B2_Blocal_r2_r("buf_flip_B2_Blocal_r2_r",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary); // ~1Gb of data
    buffer buf_flip_B2_Blocal_r2_i("buf_flip_B2_Blocal_r2_i",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_flip_B2_Bfirst_r2_r("buf_flip_B2_Bfirst_r2_r",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_flip_B2_Bfirst_r2_i("buf_flip_B2_Bfirst_r2_i",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_flip_B2_Bsecond_r2_r("buf_flip_B2_Bsecond_r2_r",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_flip_B2_Bsecond_r2_i("buf_flip_B2_Bsecond_r2_i",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_flip_B2_Bthird_r2_r("buf_flip_B2_Bthird_r2_r",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    buffer buf_flip_B2_Bthird_r2_i("buf_flip_B2_Bthird_r2_i",   { Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Nsrc, Vsnk / tiling_factor, Nc, Ns }, p_float32, a_temporary);
    ...
    buffer buf_B2_Blocal_diquark_r2_r("buf_B2_Blocal_diquark_r2_r",   {Vsnk / tiling_factor, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B2_Blocal_diquark_r2_i("buf_B2_Blocal_diquark_r2_i",   {Vsnk / tiling_factor, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B2_Bfirst_diquark_r2_r("buf_B2_Bfirst_diquark_r2_r",   {Vsnk / tiling_factor, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B2_Bfirst_diquark_r2_i("buf_B2_Bfirst_diquark_r2_i",   {Vsnk / tiling_factor, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B2_Bthird_diquark_r2_r("buf_B2_Bthird_diquark_r2_r",   {Vsnk / tiling_factor, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B2_Bthird_diquark_r2_i("buf_B2_Bthird_diquark_r2_i",   {Vsnk / tiling_factor, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    ...
    buffer buf_B2_Blocal_props_r2_r("buf_B2_Blocal_props_r2_r",   {Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B2_Blocal_props_r2_i("buf_B2_Blocal_props_r2_i",   {Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B2_Bfirst_props_r2_r("buf_B2_Bfirst_props_r2_r",   {Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B2_Bfirst_props_r2_i("buf_B2_Bfirst_props_r2_i",   {Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B2_Bsecond_props_r2_r("buf_B2_Bsecond_props_r2_r",   {Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B2_Bsecond_props_r2_i("buf_B2_Bsecond_props_r2_i",   {Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B2_Bthird_props_r2_r("buf_B2_Bthird_props_r2_r",   {Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    buffer buf_B2_Bthird_props_r2_i("buf_B2_Bthird_props_r2_i",   {Vsnk / tiling_factor, Nc, Ns, Nc, Ns, Vsnk / tiling_factor, Nc, Ns}, p_float32, a_temporary);
    ...
    buffer buf_src_B1_Blocal_r1_r("buf_src_B1_Blocal_r1_r",   {Vsnk/sites_per_rank, Nc, Ns, Nc, Ns, Nc, Ns, Nsrc, sites_per_rank}, p_float32, a_temporary);
    buffer buf_src_B1_Blocal_r1_i("buf_src_B1_Blocal_r1_i",   {Vsnk/sites_per_rank, Nc, Ns, Nc, Ns, Nc, Ns, Nsrc, sites_per_rank}, p_float32, a_temporary);
    ...
    buffer buf_flip_src_B1_Blocal_r1_r("buf_flip_src_B1_Blocal_r1_r",   {Vsnk/sites_per_rank, Nc, Ns, Nc, Ns, Nc, Ns, Nsrc, sites_per_rank}, p_float32, a_temporary);
    buffer buf_flip_src_B1_Blocal_r1_i("buf_flip_src_B1_Blocal_r1_i",   {Vsnk/sites_per_rank, Nc, Ns, Nc, Ns, Nc, Ns, Nsrc, sites_per_rank}, p_float32, a_temporary);
    ...
    buffer buf_src_B1_Blocal_diquark_r1_r("buf_src_B1_Blocal_diquark_r1_r",   {Vsnk/sites_per_rank, sites_per_rank}, p_float32, a_temporary);
    buffer buf_src_B1_Blocal_diquark_r1_i("buf_src_B1_Blocal_diquark_r1_i",   {Vsnk/sites_per_rank, sites_per_rank}, p_float32, a_temporary);
    ...
    buffer buf_src_B1_Blocal_props_r1_r("buf_src_B1_Blocal_props_r1_r",   {Vsnk/sites_per_rank, Nc, Ns, sites_per_rank}, p_float32, a_temporary);
    buffer buf_src_B1_Blocal_props_r1_i("buf_src_B1_Blocal_props_r1_i",   {Vsnk/sites_per_rank, Nc, Ns, sites_per_rank}, p_float32, a_temporary);
    ...
    buffer buf_src_B1_Blocal_r2_r("buf_src_B1_Blocal_r2_r",   {Vsnk/sites_per_rank, Nc, Ns, Nc, Ns, Nc, Ns, Nsrc, sites_per_rank}, p_float32, a_temporary);
    buffer buf_src_B1_Blocal_r2_i("buf_src_B1_Blocal_r2_i",   {Vsnk/sites_per_rank, Nc, Ns, Nc, Ns, Nc, Ns, Nsrc, sites_per_rank}, p_float32, a_temporary);
    ...
    buffer buf_flip_src_B1_Blocal_r2_r("buf_flip_src_B1_Blocal_r2_r",   {Vsnk/sites_per_rank, Nc, Ns, Nc, Ns, Nc, Ns, Nsrc, sites_per_rank}, p_float32, a_temporary);
    buffer buf_flip_src_B1_Blocal_r2_i("buf_flip_src_B1_Blocal_r2_i",   {Vsnk/sites_per_rank, Nc, Ns, Nc, Ns, Nc, Ns, Nsrc, sites_per_rank}, p_float32, a_temporary);
    ...
    buffer buf_src_B1_Blocal_diquark_r2_r("buf_src_B1_Blocal_diquark_r2_r",   {Vsnk/sites_per_rank, sites_per_rank}, p_float32, a_temporary);
    buffer buf_src_B1_Blocal_diquark_r2_i("buf_src_B1_Blocal_diquark_r2_i",   {Vsnk/sites_per_rank, sites_per_rank}, p_float32, a_temporary);
    ...
    buffer buf_src_B1_Blocal_props_r2_r("buf_src_B1_Blocal_props_r2_r",   {Vsnk/sites_per_rank, Nc, Ns, sites_per_rank}, p_float32, a_temporary);
    buffer buf_src_B1_Blocal_props_r2_i("buf_src_B1_Blocal_props_r2_i",   {Vsnk/sites_per_rank, Nc, Ns, sites_per_rank}, p_float32, a_temporary);
    ...
    buffer buf_src_B2_Blocal_r1_r("buf_src_B2_Blocal_r1_r",   {Vsnk/sites_per_rank, Nc, Ns, Nc, Ns, Nc, Ns, Nsrc, sites_per_rank}, p_float32, a_temporary);
    buffer buf_src_B2_Blocal_r1_i("buf_src_B2_Blocal_r1_i",   {Vsnk/sites_per_rank, Nc, Ns, Nc, Ns, Nc, Ns, Nsrc, sites_per_rank}, p_float32, a_temporary);
    ...
    buffer buf_flip_src_B2_Blocal_r1_r("buf_flip_src_B2_Blocal_r1_r",   {Vsnk/sites_per_rank, Nc, Ns, Nc, Ns, Nc, Ns, Nsrc, sites_per_rank}, p_float32, a_temporary);
    buffer buf_flip_src_B2_Blocal_r1_i("buf_flip_src_B2_Blocal_r1_i",   {Vsnk/sites_per_rank, Nc, Ns, Nc, Ns, Nc, Ns, Nsrc, sites_per_rank}, p_float32, a_temporary);
    ...
    buffer buf_src_B2_Blocal_diquark_r1_r("buf_src_B2_Blocal_diquark_r1_r",   {Vsnk/sites_per_rank, sites_per_rank}, p_float32, a_temporary);
    buffer buf_src_B2_Blocal_diquark_r1_i("buf_src_B2_Blocal_diquark_r1_i",   {Vsnk/sites_per_rank, sites_per_rank}, p_float32, a_temporary);
    ...
    buffer buf_src_B2_Blocal_props_r1_r("buf_src_B2_Blocal_props_r1_r",   {Vsnk/sites_per_rank, Nc, Ns, sites_per_rank}, p_float32, a_temporary);
    buffer buf_src_B2_Blocal_props_r1_i("buf_src_B2_Blocal_props_r1_i",   {Vsnk/sites_per_rank, Nc, Ns, sites_per_rank}, p_float32, a_temporary);
    ...
    buffer buf_src_B2_Blocal_r2_r("buf_src_B2_Blocal_r2_r",   {Vsnk/sites_per_rank, Nc, Ns, Nc, Ns, Nc, Ns, Nsrc, sites_per_rank}, p_float32, a_temporary);
    buffer buf_src_B2_Blocal_r2_i("buf_src_B2_Blocal_r2_i",   {Vsnk/sites_per_rank, Nc, Ns, Nc, Ns, Nc, Ns, Nsrc, sites_per_rank}, p_float32, a_temporary);
    ...
    buffer buf_flip_src_B2_Blocal_r2_r("buf_flip_src_B2_Blocal_r2_r",   {Vsnk/sites_per_rank, Nc, Ns, Nc, Ns, Nc, Ns, Nsrc, sites_per_rank}, p_float32, a_temporary);
    buffer buf_flip_src_B2_Blocal_r2_i("buf_flip_src_B2_Blocal_r2_i",   {Vsnk/sites_per_rank, Nc, Ns, Nc, Ns, Nc, Ns, Nsrc, sites_per_rank}, p_float32, a_temporary);
    ...
    buffer buf_src_B2_Blocal_diquark_r2_r("buf_src_B2_Blocal_diquark_r2_r",   {Vsnk/sites_per_rank, sites_per_rank}, p_float32, a_temporary);
    buffer buf_src_B2_Blocal_diquark_r2_i("buf_src_B2_Blocal_diquark_r2_i",   {Vsnk/sites_per_rank, sites_per_rank}, p_float32, a_temporary);
    ...
    buffer buf_src_B2_Blocal_props_r2_r("buf_src_B2_Blocal_props_r2_r",   {Vsnk/sites_per_rank, Nc, Ns, sites_per_rank}, p_float32, a_temporary);
    buffer buf_src_B2_Blocal_props_r2_i("buf_src_B2_Blocal_props_r2_i",   {Vsnk/sites_per_rank, Nc, Ns, sites_per_rank}, p_float32, a_temporary);
    ...
    buffer buf_snk_B1_Blocal_r1_r("buf_snk_B1_Blocal_r1_r",   {Vsnk/sites_per_rank, Nc, Ns, Nc, Ns, Nc, Ns, Nsnk, sites_per_rank}, p_float32, a_temporary);
    buffer buf_snk_B1_Blocal_r1_i("buf_snk_B1_Blocal_r1_i",   {Vsnk/sites_per_rank, Nc, Ns, Nc, Ns, Nc, Ns, Nsnk, sites_per_rank}, p_float32, a_temporary);
    ...
    buffer buf_flip_snk_B1_Blocal_r1_r("buf_flip_snk_B1_Blocal_r1_r",   {Vsnk/sites_per_rank, Nc, Ns, Nc, Ns, Nc, Ns, Nsnk, sites_per_rank}, p_float32, a_temporary);
    buffer buf_flip_snk_B1_Blocal_r1_i("buf_flip_snk_B1_Blocal_r1_i",   {Vsnk/sites_per_rank, Nc, Ns, Nc, Ns, Nc, Ns, Nsnk, sites_per_rank}, p_float32, a_temporary);
    ...
    buffer buf_snk_B1_Blocal_diquark_r1_r("buf_snk_B1_Blocal_diquark_r1_r",   {Vsnk/sites_per_rank, sites_per_rank}, p_float32, a_temporary);
    buffer buf_snk_B1_Blocal_diquark_r1_i("buf_snk_B1_Blocal_diquark_r1_i",   {Vsnk/sites_per_rank, sites_per_rank}, p_float32, a_temporary);
    ...
    buffer buf_snk_B1_Blocal_props_r1_r("buf_snk_B1_Blocal_props_r1_r",   {Vsnk/sites_per_rank, Nc, Ns, sites_per_rank}, p_float32, a_temporary);
    buffer buf_snk_B1_Blocal_props_r1_i("buf_snk_B1_Blocal_props_r1_i",   {Vsnk/sites_per_rank, Nc, Ns, sites_per_rank}, p_float32, a_temporary);
    ...
    buffer buf_snk_B1_Blocal_r2_r("buf_snk_B1_Blocal_r2_r",   {Vsnk/sites_per_rank, Nc, Ns, Nc, Ns, Nc, Ns, Nsnk, sites_per_rank}, p_float32, a_temporary);
    buffer buf_snk_B1_Blocal_r2_i("buf_snk_B1_Blocal_r2_i",   {Vsnk/sites_per_rank, Nc, Ns, Nc, Ns, Nc, Ns, Nsnk, sites_per_rank}, p_float32, a_temporary);
    ...
    buffer buf_flip_snk_B1_Blocal_r2_r("buf_flip_snk_B1_Blocal_r2_r",   {Vsnk/sites_per_rank, Nc, Ns, Nc, Ns, Nc, Ns, Nsnk, sites_per_rank}, p_float32, a_temporary);
    buffer buf_flip_snk_B1_Blocal_r2_i("buf_flip_snk_B1_Blocal_r2_i",   {Vsnk/sites_per_rank, Nc, Ns, Nc, Ns, Nc, Ns, Nsnk, sites_per_rank}, p_float32, a_temporary);
    ...
    buffer buf_snk_B1_Blocal_diquark_r2_r("buf_snk_B1_Blocal_diquark_r2_r",   {Vsnk/sites_per_rank, sites_per_rank}, p_float32, a_temporary);
    buffer buf_snk_B1_Blocal_diquark_r2_i("buf_snk_B1_Blocal_diquark_r2_i",   {Vsnk/sites_per_rank, sites_per_rank}, p_float32, a_temporary);
    ...
    buffer buf_snk_B1_Blocal_props_r2_r("buf_snk_B1_Blocal_props_r2_r",   {Vsnk/sites_per_rank, Nc, Ns, sites_per_rank}, p_float32, a_temporary);
    buffer buf_snk_B1_Blocal_props_r2_i("buf_snk_B1_Blocal_props_r2_i",   {Vsnk/sites_per_rank, Nc, Ns, sites_per_rank}, p_float32, a_temporary);
    ...
    buffer buf_snk_B2_Blocal_r1_r("buf_snk_B2_Blocal_r1_r",   {Vsnk/sites_per_rank, Nc, Ns, Nc, Ns, Nc, Ns, Nsnk, sites_per_rank}, p_float32, a_temporary);
    buffer buf_snk_B2_Blocal_r1_i("buf_snk_B2_Blocal_r1_i",   {Vsnk/sites_per_rank, Nc, Ns, Nc, Ns, Nc, Ns, Nsnk, sites_per_rank}, p_float32, a_temporary);
    ...
    buffer buf_flip_snk_B2_Blocal_r1_r("buf_flip_snk_B2_Blocal_r1_r",   {Vsnk/sites_per_rank, Nc, Ns, Nc, Ns, Nc, Ns, Nsnk, sites_per_rank}, p_float32, a_temporary);
    buffer buf_flip_snk_B2_Blocal_r1_i("buf_flip_snk_B2_Blocal_r1_i",   {Vsnk/sites_per_rank, Nc, Ns, Nc, Ns, Nc, Ns, Nsnk, sites_per_rank}, p_float32, a_temporary);
    ...
    buffer buf_snk_B2_Blocal_diquark_r1_r("buf_snk_B2_Blocal_diquark_r1_r",   {Vsnk/sites_per_rank, sites_per_rank}, p_float32, a_temporary);
    buffer buf_snk_B2_Blocal_diquark_r1_i("buf_snk_B2_Blocal_diquark_r1_i",   {Vsnk/sites_per_rank, sites_per_rank}, p_float32, a_temporary);
    ...
    buffer buf_snk_B2_Blocal_props_r1_r("buf_snk_B2_Blocal_props_r1_r",   {Vsnk/sites_per_rank, Nc, Ns, sites_per_rank}, p_float32, a_temporary);
    buffer buf_snk_B2_Blocal_props_r1_i("buf_snk_B2_Blocal_props_r1_i",   {Vsnk/sites_per_rank, Nc, Ns, sites_per_rank}, p_float32, a_temporary);
    ...
    buffer buf_snk_B2_Blocal_r2_r("buf_snk_B2_Blocal_r2_r",   {Vsnk/sites_per_rank, Nc, Ns, Nc, Ns, Nc, Ns, Nsnk, sites_per_rank}, p_float32, a_temporary);
    buffer buf_snk_B2_Blocal_r2_i("buf_snk_B2_Blocal_r2_i",   {Vsnk/sites_per_rank, Nc, Ns, Nc, Ns, Nc, Ns, Nsnk, sites_per_rank}, p_float32, a_temporary);
    ...
    buffer buf_flip_snk_B2_Blocal_r2_r("buf_flip_snk_B2_Blocal_r2_r",   {Vsnk/sites_per_rank, Nc, Ns, Nc, Ns, Nc, Ns, Nsnk, sites_per_rank}, p_float32, a_temporary);
    buffer buf_flip_snk_B2_Blocal_r2_i("buf_flip_snk_B2_Blocal_r2_i",   {Vsnk/sites_per_rank, Nc, Ns, Nc, Ns, Nc, Ns, Nsnk, sites_per_rank}, p_float32, a_temporary);
    ...
    buffer buf_snk_B2_Blocal_diquark_r2_r("buf_snk_B2_Blocal_diquark_r2_r",   {Vsnk/sites_per_rank, sites_per_rank}, p_float32, a_temporary);
    buffer buf_snk_B2_Blocal_diquark_r2_i("buf_snk_B2_Blocal_diquark_r2_i",   {Vsnk/sites_per_rank, sites_per_rank}, p_float32, a_temporary);
    ...
    buffer buf_snk_B2_Blocal_props_r2_r("buf_snk_B2_Blocal_props_r2_r",   {Vsnk/sites_per_rank, Nc, Ns, sites_per_rank}, p_float32, a_temporary);
    buffer buf_snk_B2_Blocal_props_r2_i("buf_snk_B2_Blocal_props_r2_i",   {Vsnk/sites_per_rank, Nc, Ns, sites_per_rank}, p_float32, a_temporary);
    ...
    buffer buf_C_r("buf_C_r", {Lt, Vsnk/sites_per_rank, sites_per_rank, B2Nrows, NsrcTot, B2Nrows, NsnkTot}, p_float32, a_temporary);
    buffer buf_C_i("buf_C_i", {Lt, Vsnk/sites_per_rank, sites_per_rank, B2Nrows, NsrcTot, B2Nrows, NsnkTot}, p_float32, a_temporary);
    ...
    buffer buf_C_BB_BB_prop_r("buf_C_BB_BB_prop_r", { Vsnk / tiling_factor, B2Nrows, Nsrc, B2Nrows, Vsnk / tiling_factor}, p_float32, a_temporary);
    buffer buf_C_BB_BB_prop_i("buf_C_BB_BB_prop_i", { Vsnk / tiling_factor, B2Nrows, Nsrc, B2Nrows, Vsnk / tiling_factor}, p_float32, a_temporary);
    ...
    buffer buf_C_BB_H_prop_r("buf_C_BB_H_prop_r", {Lt, Vsnk/sites_per_rank, sites_per_rank}, p_float32, a_temporary);
    buffer buf_C_BB_H_prop_i("buf_C_BB_H_prop_i", {Lt, Vsnk/sites_per_rank, sites_per_rank}, p_float32, a_temporary);
    ...
    buffer buf_C_H_BB_prop_r("buf_C_H_BB_prop_r", {Lt, Vsnk/sites_per_rank, sites_per_rank, 1}, p_float32, a_temporary);
    buffer buf_C_H_BB_prop_i("buf_C_H_BB_prop_i", {Lt, Vsnk/sites_per_rank, sites_per_rank, 1}, p_float32, a_temporary);
    ...
    buffer buff_H_BB_term_res_comp_r("buff_H_BB_term_res_comp_r", {Lt, Vsnk/sites_per_rank, sites_per_rank, 1}, p_float32, a_temporary);
    buffer buff_H_BB_term_res_comp_i("buff_H_BB_term_res_comp_i", {Lt, Vsnk/sites_per_rank, sites_per_rank, 1}, p_float32, a_temporary);
    ...
    buffer buf_C_H_H_prop_r("buf_C_H_H_prop_r", {Lt, Vsnk/sites_per_rank, sites_per_rank, 1}, p_float32, a_temporary);
    buffer buf_C_H_H_prop_i("buf_C_H_H_prop_i", {Lt, Vsnk/sites_per_rank, sites_per_rank, 1}, p_float32, a_temporary);
    ...
    computation copy_buf_C_BB_r_device_to_host({t, tile1, tile2}, memcpy(buf_C_BB_r, buf_C_BB_r_cpu));
    computation copy_buf_C_BB_i_device_to_host({t, tile1, tile2}, memcpy(buf_C_BB_i, buf_C_BB_i_cpu));
...
// kernel_11:
    ...
    tiramisu::codegen({
        ...
        "generated_gpu_single_tiramisu_make_fused_identical_dibaryon_blocks_correlator.o", true);
}

int main(int argc, char **argv)
{
	generate_function("gpu_single_tiramisu_make_fused_identical_dibaryon_blocks_correlator");
